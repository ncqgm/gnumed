...
* <<rel-xyrcn,Release Candidate>> (X.Y.rc1-n)
* <<rel-xy0,Feature Release>> (X-Y-0)
* <<rel-xyn,Maintenance Release>> (X-Y-1-n)
...
[#rel-xyrcn]
== Preparing a Release Candidate (_X.Y.rc1-n_)
...
[#rel-xyn]
== Doing a Maintenance Release (_X.Y.1-n_)
...
* update link:index[release status] page
