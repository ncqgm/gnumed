...
#ifndef HOMEBUSINESS_H
#define HOMEBUSINESS_H
...
/**
  ...
  * and statusbar. For the main view, an instance of class HomeBusinessView is
  * created which creates your view.
  */
class HomeBusinessApp : public QMainWindow
{
  Q_OBJECT
