...
myfebrl = Febrl(description = 'Example deduplication Febrl instance, run on output of read_v_febrl_demo.py which was directed to {basepath}/dbgen/file-gnumed.csv',
                 febrl_path = basepath)

myproject = myfebrl.new_project(name = 'example-gnumed2file-dedup',
...
mylog = ProjectLog(file_name = 'example-gnumed2file-dedup.log',
                     project = myproject,
                   log_level = 1,
               verbose_level = 1,
                   clear_log = True,
...
indata = DataSetCSV(name = 'example2in',
             description = 'gnumed contents dumped file-gnumed.csv',
             access_mode = 'read',
            header_lines = 1,
               file_name = basepath+'/dbgen/file-gnumed.csv',
                  fields = {'rec_id':0,
                            'given_name':1,
                            'surname':2,
                            'street_num':3,
...
myproject.deduplicate(input_dataset = indata,
                   ...
                   output_histogram = 'example-dedup-gnumed-file-histogram.res',
            output_rec_pair_details = 'example-dedup-gnumed-file-details.res',
            output_rec_pair_weights = 'example-dedup-gnumed-file-weights.res',
