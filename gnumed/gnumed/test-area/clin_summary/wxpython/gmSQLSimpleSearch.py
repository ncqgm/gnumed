...
#----------- changed 21/03/2002
		data = self.listctrlSearchResults.GetRow(index)
		print index, data
		self.listctrl_index = index
		self.listctrl_sel_data = data

	def GetSelectedRow(self):
		return self.listctrlSearchResults.GetSelectedRow()
