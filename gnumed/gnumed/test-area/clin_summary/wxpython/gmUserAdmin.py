...
#     Revision 1.1  2002-04-07 13:37:06  sjtan
#     uses test database in ../sql : simple clinical tables hierarchy, for experimentation.
#     SimpleSummaryUI shows a summary notebook page, with popup expansion of different parts
#     of the summary like large hints.
#     `
#
