...
# @TODO:
############################################################################
# $Source: /home/ncq/Projekte/cvs2git/vcs-mirror/gnumed/gnumed/test-area/test-client-c/python-common/Attic/gmLoginInfo.py,v $
# $Id: gmLoginInfo.py,v 1.1 2003-10-23 06:02:39 sjtan Exp $
