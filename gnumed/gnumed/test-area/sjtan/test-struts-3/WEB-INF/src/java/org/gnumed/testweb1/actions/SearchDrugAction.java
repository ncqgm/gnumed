...
public class SearchDrugAction extends Action {
    ...
    HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            //                if (form == null) {
            //                    form = (ClinicalUpdateForm) request.getSession().getAttribute(Constants.Session.CURRENT_CLINICAL_FORM);
            //                }
            //                ClinicalUpdateForm cform = (ClinicalUpdateForm) form;
            //                int medIndex = Integer.parseInt(request.getParameter(Constants.Request.MEDICATION_ENTRY_INDEX).toString());
