...
protected void setStatement(EntryMedication med, ClinRootInsert rootItemInserter, PreparedStatement stmt) throws DataSourceException, SQLException {
		...
		stmt.setString(++j , "{" + String.valueOf(med.getConvertedDose()) + " }");
		//changed
...
//		stmt.setBoolean(++j,  med.isSR());
		...
		{	
			...
			log.info("setting statment param " + j+1 + " to " + med.getGenericName());
	...
	public String getInsertStatement(ClinRootInsert rootItemInserter) {
		String s9 = "insert into clin_medication(" + ClinMedicationFieldsV02.pk_item + ", " + ClinMedicationFieldsV02.brandName
				+ ", " +ClinMedicationFieldsV02. atc_code + ", " +ClinMedicationFieldsV02.db_origin + ", " +ClinMedicationFieldsV02.db_drug_id + ", "
				+ ClinMedicationFieldsV02.amount_unit + ", " + ClinMedicationFieldsV02.dose + ", " + ClinMedicationFieldsV02.period + ", " +ClinMedicationFieldsV02. form
				+ ", " +ClinMedicationFieldsV02. directions + ", " +ClinMedicationFieldsV02. prn + ", "// + started  +", " //- deprecated to clin_when?
				 +ClinMedicationFieldsV02.last_prescribed + ", " + ClinMedicationFieldsV02.discontinued + ", " + // 14
																									// fields
																									// here
