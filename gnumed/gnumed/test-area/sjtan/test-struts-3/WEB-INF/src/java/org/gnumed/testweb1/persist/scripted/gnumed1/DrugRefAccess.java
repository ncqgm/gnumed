...
public interface DrugRefAccess extends DataSourceUsing, DataObjectFactoryUsing {
    ...
    final static String ID_PRODUCT="id_product", BRAND_NAME="brandname", 
	...
	DRUG_SHORT_DESCRIPTION="drug_description";
    ...
    final static String SELECT_PRODUCTS_DRUGREF=	"select distinct(p.id) as "+ID_PRODUCT+",  lpm.brandname as "+ BRAND_NAME+", "+
    	"atc.code as "+ATC_CODE +", atc.text as "+ATC_NAME + ", " +
		"pkgsz.size as " +PKG_SIZE + " , " +
    ...
    final static String CREATE_VIEW_DRUGS = "create view "+VIEW_NAME+" as select * from ( "
    	+SELECT_PRODUCTS_DRUGREF+") as products " +
				...
				") as subsidies on (products.id_product = subsidites.id_product) ";
