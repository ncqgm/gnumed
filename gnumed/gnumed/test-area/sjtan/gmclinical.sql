-- Project: GnuMed
-- ===================================================================
-- $Source: /home/ncq/Projekte/cvs2git/vcs-mirror/gnumed/gnumed/test-area/sjtan/Attic/gmclinical.sql,v $
-- $Revision: 1.1 $
-- license: GPL
...
INSERT INTO gm_schema_revision (filename, version) VALUES('$RCSfile: gmclinical.sql,v $', '$Revision: 1.1 $');

-- =============================================
-- $Log: gmclinical.sql,v $
-- Revision 1.1  2003-02-02 22:43:05  sjtan
--
-- playing around with the idea of semi-auto gui generation ; idea: get the server to deal out referencing
