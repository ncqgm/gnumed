# ['.#gmGP_Allergies.py', 'gmBMICalc.py', 'gmCalcPreg.py', 'gmCrypto.py', 'gmDemographics.py', 'gmGP_Allergies.py', 'gmGP_AnteNatal_3.py', 'gmGP_ClinicalSummary.py', 'gmGP_FamilyHistory.py', 'gmGP_Immunisation.py', 'gmGP_Measurements.py', 'gmGP_PastHistory.py', 'gmGP_Prescriptions.py', 'gmGP_Recalls.py', 'gmGP_Referrals.py', 'gmGP_Requests.py', 'gmGP_ScratchPadRecalls.py', 'gmGP_TabbedLists.py']
...
class gmGP_FamilyHistory_funcs:
...
class gmGP_Prescriptions_funcs:
...
class gmGP_ScratchPadRecalls_funcs:
...
class gmBMICalc_handler(base_handler, gmBMICalc_funcs):
...
class gmBMICalc_mapping_handler(gmBMICalc_handler):
	def __init__(self, panel = None, model = None, impl = None):
		gmBMICalc_handler.__init__(self, panel, model, impl)
	...
	def txtHeight_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txtHeight_text_entered(  event) 
...
class gmDemographics_handler(base_handler, gmDemographics_funcs):
...
class gmDemographics_mapping_handler(gmDemographics_handler):
	def __init__(self, panel = None, model = None, impl = None):
		gmDemographics_handler.__init__(self, panel, model, impl)
	...
	def addresslist_list_box_single_clicked( self, event): 
		...
		if self.impl <> None:
			self.impl.addresslist_list_box_single_clicked(  event) 
	...
	def addresslist_list_box_double_clicked( self, event): 
		...
		if self.impl <> None:
			self.impl.addresslist_list_box_double_clicked(  event) 
	...
	def combo_relationship_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.combo_relationship_text_entered(  event) 
	...
	def txt_surname_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_surname_text_entered(  event) 
	...
	def combo_title_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.combo_title_text_entered(  event) 
	...
	def txt_firstname_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_firstname_text_entered(  event) 
	...
	def combo_sex_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.combo_sex_text_entered(  event) 
	...
	def cb_preferredname_checkbox_clicked( self, event): 
		...
		if self.impl <> None:
			self.impl.cb_preferredname_checkbox_clicked(  event) 
	...
	def txt_preferred_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_preferred_text_entered(  event) 
	...
	def txt_address_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_address_text_entered(  event) 
	...
	def txt_suburb_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_suburb_text_entered(  event) 
	...
	def txt_zip_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_zip_text_entered(  event) 
	...
	def txt_birthdate_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_birthdate_text_entered(  event) 
	...
	def combo_maritalstatus_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.combo_maritalstatus_text_entered(  event) 
	...
	def txt_occupation_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_occupation_text_entered(  event) 
	...
	def txt_countryofbirth_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_countryofbirth_text_entered(  event) 
	...
	def btn_browseNOK_button_clicked( self, event): 
		...
		if self.impl <> None:
			self.impl.btn_browseNOK_button_clicked(  event) 
	...
	def txt_nameNOK_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_nameNOK_text_entered(  event) 
	...
	def txt_homephone_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_homephone_text_entered(  event) 
	...
	def txt_workphone_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_workphone_text_entered(  event) 
	...
	def txt_fax_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_fax_text_entered(  event) 
	...
	def txt_email_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_email_text_entered(  event) 
	...
	def txt_web_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_web_text_entered(  event) 
	...
	def txt_mobile_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_mobile_text_entered(  event) 
	...
	def cb_addressresidence_checkbox_clicked( self, event): 
		...
		if self.impl <> None:
			self.impl.cb_addressresidence_checkbox_clicked(  event) 
	...
	def cb_addresspostal_checkbox_clicked( self, event): 
		...
		if self.impl <> None:
			self.impl.cb_addresspostal_checkbox_clicked(  event) 
	...
	def btn_photo_import_button_clicked( self, event): 
		...
		if self.impl <> None:
			self.impl.btn_photo_import_button_clicked(  event) 
	...
	def btn_photo_export_button_clicked( self, event): 
		...
		if self.impl <> None:
			self.impl.btn_photo_export_button_clicked(  event) 
	...
	def btn_photo_aquire_button_clicked( self, event): 
		...
		if self.impl <> None:
			self.impl.btn_photo_aquire_button_clicked(  event) 
	...
	def txt_findpatient_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_findpatient_text_entered(  event) 
	...
	def txt_age_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_age_text_entered(  event) 
	...
	def txt_allergies_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_allergies_text_entered(  event) 
	...
	def combo_consultation_type_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.combo_consultation_type_text_entered(  event) 
...
class gmGP_Allergies_handler(base_handler, gmGP_Allergies_funcs):
...
class gmGP_Allergies_mapping_handler(gmGP_Allergies_handler):
	def __init__(self, panel = None, model = None, impl = None):
		gmGP_Allergies_handler.__init__(self, panel, model, impl)
	...
	def classtxt_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.classtxt_text_entered(  event) 
...
class gmGP_FamilyHistory_handler(base_handler, gmGP_FamilyHistory_funcs):
...
class gmGP_FamilyHistory_mapping_handler(gmGP_FamilyHistory_handler):
	def __init__(self, panel = None, model = None, impl = None):
		gmGP_FamilyHistory_handler.__init__(self, panel, model, impl)
	...
	def txt_social_history_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_social_history_text_entered(  event) 
...
class gmGP_Immunisation_handler(base_handler, gmGP_Immunisation_funcs):
...
class gmGP_Immunisation_mapping_handler(gmGP_Immunisation_handler):
	def __init__(self, panel = None, model = None, impl = None):
		gmGP_Immunisation_handler.__init__(self, panel, model, impl)
	...
	def missingimmunisation_listbox_list_box_single_clicked( self, event): 
		...
		if self.impl <> None:
			self.impl.missingimmunisation_listbox_list_box_single_clicked(  event) 
	...
	def missingimmunisation_listbox_list_box_double_clicked( self, event): 
		...
		if self.impl <> None:
			self.impl.missingimmunisation_listbox_list_box_double_clicked(  event) 
...
class gmGP_Prescriptions_handler(base_handler, gmGP_Prescriptions_funcs):
...
class gmGP_Prescriptions_mapping_handler(gmGP_Prescriptions_handler):
	def __init__(self, panel = None, model = None, impl = None):
		gmGP_Prescriptions_handler.__init__(self, panel, model, impl)
	...
	def txt_scriptDate_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_scriptDate_text_entered(  event) 
	...
	def interactiontxt_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.interactiontxt_text_entered(  event) 
...
class gmGP_Referrals_handler(base_handler, gmGP_Referrals_funcs):
...
class gmGP_Referrals_mapping_handler(gmGP_Referrals_handler):
	def __init__(self, panel = None, model = None, impl = None):
		gmGP_Referrals_handler.__init__(self, panel, model, impl)
	...
	def txt_referraldate_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_referraldate_text_entered(  event) 
	...
	def txt_referral_letter_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_referral_letter_text_entered(  event) 
...
class gmGP_Requests_handler(base_handler, gmGP_Requests_funcs):
...
class gmGP_Requests_mapping_handler(gmGP_Requests_handler):
	def __init__(self, panel = None, model = None, impl = None):
		gmGP_Requests_handler.__init__(self, panel, model, impl)
	...
	def txt_requestDate_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.txt_requestDate_text_entered(  event) 
...
class gmGP_ScratchPadRecalls_handler(base_handler, gmGP_ScratchPadRecalls_funcs):
...
class gmGP_ScratchPadRecalls_mapping_handler(gmGP_ScratchPadRecalls_handler):
	def __init__(self, panel = None, model = None, impl = None):
		gmGP_ScratchPadRecalls_handler.__init__(self, panel, model, impl)
	...
	def scratchpad_txt_text_entered( self, event): 
		...
		if self.impl <> None:
			self.impl.scratchpad_txt_text_entered(  event) 
...
# []
# [('txtHeight', 'wxTextCtrl')]
GuiBroker()['gmBMICalc_handler']= gmBMICalc_mapping_handler()
print 'GuiBroker has handler', GuiBroker()['gmBMICalc_handler']
# []
# []
# found new type = TextBox_RedBold which is base_type wxTextCtrl
...
# [('addresslist', 'wxListBox'), ('combo_relationship', 'wxComboBox'), ('txt_surname', 'TextBox_RedBold'), ('combo_title', 'wxComboBox'), ('txt_firstname', 'TextBox_RedBold'), ('combo_sex', 'wxComboBox'), ('cb_preferredname', 'wxCheckBox'), ('txt_preferred', 'TextBox_RedBold'), ('txt_address', 'wxTextCtrl'), ('txt_suburb', 'TextBox_BlackNormal'), ('txt_zip', 'TextBox_BlackNormal'), ('txt_birthdate', 'TextBox_BlackNormal'), ('combo_maritalstatus', 'wxComboBox'), ('txt_occupation', 'TextBox_BlackNormal'), ('txt_countryofbirth', 'TextBox_BlackNormal'), ('btn_browseNOK', 'wxButton'), ('txt_nameNOK', 'wxTextCtrl'), ('txt_homephone', 'TextBox_BlackNormal'), ('txt_workphone', 'TextBox_BlackNormal'), ('txt_fax', 'TextBox_BlackNormal'), ('txt_email', 'TextBox_BlackNormal'), ('txt_web', 'TextBox_BlackNormal'), ('txt_mobile', 'TextBox_BlackNormal'), ('cb_addressresidence', 'wxCheckBox'), ('cb_addresspostal', 'wxCheckBox'), ('btn_photo_import', 'wxButton'), ('btn_photo_export', 'wxButton'), ('btn_photo_aquire', 'wxButton'), ('txt_findpatient', 'wxComboBox'), ('txt_age', 'wxTextCtrl'), ('txt_allergies', 'wxTextCtrl'), ('combo_consultation_type', 'wxComboBox')]
GuiBroker()['gmDemographics_handler']= gmDemographics_mapping_handler()
print 'GuiBroker has handler', GuiBroker()['gmDemographics_handler']
# [('classtxt', 'wxTextCtrl')]
GuiBroker()['gmGP_Allergies_handler']= gmGP_Allergies_mapping_handler()
print 'GuiBroker has handler', GuiBroker()['gmGP_Allergies_handler']
# []
# []
# [('txt_social_history', 'wxTextCtrl')]
GuiBroker()['gmGP_FamilyHistory_handler']= gmGP_FamilyHistory_mapping_handler()
print 'GuiBroker has handler', GuiBroker()['gmGP_FamilyHistory_handler']
# [('missingimmunisation_listbox', 'wxListBox')]
GuiBroker()['gmGP_Immunisation_handler']= gmGP_Immunisation_mapping_handler()
print 'GuiBroker has handler', GuiBroker()['gmGP_Immunisation_handler']
# []
# []
# [('txt_scriptDate', 'wxTextCtrl'), ('interactiontxt', 'wxTextCtrl')]
GuiBroker()['gmGP_Prescriptions_handler']= gmGP_Prescriptions_mapping_handler()
print 'GuiBroker has handler', GuiBroker()['gmGP_Prescriptions_handler']
# []
# [('txt_referraldate', 'wxTextCtrl'), ('txt_referral_letter', 'wxTextCtrl')]
GuiBroker()['gmGP_Referrals_handler']= gmGP_Referrals_mapping_handler()
print 'GuiBroker has handler', GuiBroker()['gmGP_Referrals_handler']
# [('txt_requestDate', 'wxTextCtrl')]
GuiBroker()['gmGP_Requests_handler']= gmGP_Requests_mapping_handler()
print 'GuiBroker has handler', GuiBroker()['gmGP_Requests_handler']
# [('scratchpad_txt', 'wxTextCtrl')]
GuiBroker()['gmGP_ScratchPadRecalls_handler']= gmGP_ScratchPadRecalls_mapping_handler()
print 'GuiBroker has handler', GuiBroker()['gmGP_ScratchPadRecalls_handler']
# []
