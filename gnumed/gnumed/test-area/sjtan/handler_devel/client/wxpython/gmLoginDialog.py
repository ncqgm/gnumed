...
# @TODO:
############################################################################
# $Source: /home/ncq/Projekte/cvs2git/vcs-mirror/gnumed/gnumed/test-area/sjtan/handler_devel/client/wxpython/Attic/gmLoginDialog.py,v $
# $Id: gmLoginDialog.py,v 1.1 2003-02-23 04:08:03 sjtan Exp $
