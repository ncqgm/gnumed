...
############################################################################
# $Source: /home/ncq/Projekte/cvs2git/vcs-mirror/gnumed/gnumed/test-area/sjtan/handler_devel/client/python-common/Attic/gmPlugin.py,v $
# $Id: gmPlugin.py,v 1.1 2003-02-23 04:12:45 sjtan Exp $
