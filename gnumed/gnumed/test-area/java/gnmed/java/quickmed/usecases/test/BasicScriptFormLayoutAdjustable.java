/*
 * BasicScriptFormLayoutAdjustable.java
 *
 * Created on 1 September 2003, 22:29
 */
 ...
 * @author  syan
 */
public interface BasicScriptFormLayoutAdjustable {
    
    /** Getter for property originProviderDetails.
     * @return Value of property originProviderDetails.
     *
     */
    public Point getOriginProviderDetails();
    
    /** Setter for property originProviderDetails.
     * @param originProviderDetails New value of property originProviderDetails.
     *
     */
    public void setOriginProviderDetails(Point originProviderDetails);
    
    /** Getter for property originHealthNumber.
     * @return Value of property originHealthNumber.
     *
     */
    public Point getOriginHealthNumber();
    
    /** Setter for property originHealthNumber.
     * @param originHealthNumber New value of property originHealthNumber.
     *
     */
    ...
    /** Getter for property originDrugDetails.
     * @return Value of property originDrugDetails.
     *
     */
    public Point getOriginDrugDetails();
    
    /** Setter for property originDrugDetails.
     * @param originDrugDetails New value of property originDrugDetails.
     *
     */
    ...
    /** Getter for property originSignoff.
     * @return Value of property originSignoff.
     *
     */
    public Point getOriginSignoff();
    
    /** Setter for property originSignoff.
     * @param originSignoff New value of property originSignoff.
     *
     */
