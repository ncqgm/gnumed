...
public class social_identity {
    ...
    public boolean equals(Object other) {
        if  (other instanceof social_identity) {
            social_identity sid = (social_identity) other;
            return   getId().equals(sid.getId())
            || (getNumber().equals(sid.getNumber()) && getEnum_social_id().equals(sid.getEnum_social_id()) );
        }
