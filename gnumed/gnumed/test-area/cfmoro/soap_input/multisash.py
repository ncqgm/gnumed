...
# Created:      2002/11/20
# Version:      0.1
# RCS-ID:       $Id: multisash.py,v 1.1 2005-02-14 00:58:37 cfmoro Exp $
...
class wxMultiSplit(wxWindow):
    ...
    def DestroyLeaf(self,caller):
        ...
        if parent == self.multiView:    # We'r at the root
            ...
            print "DESTROYING BOTTOM!! caller:self.view1:self.multiView.bottom_leaf %s:%s:%s" %(id(caller),id(self.view1),id(self.multiView.get_bottom_leaf()))
