...
# $Id: make-release_tarball.sh,v 1.36.2.2 2007-09-25 18:24:30 ncq Exp $
# license: GPL
#====================================================
CLIENTREV="0.2.7.1"
...
# Revision 1.36.2.2  2007-09-25 18:24:30  ncq
# - bump version
# - include zip+sign script for backup
#
# Revision 1.36.2.1  2007/09/20 22:12:00  ncq
# - v7/v0.2.7
