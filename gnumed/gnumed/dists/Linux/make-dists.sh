...
# $Id: make-dists.sh,v 1.3 2005-08-14 16:34:41 shilbert Exp $
# license: GPL
...
SUBREV=rc5
echo "=> client ..."
tar -cvhzf GNUmed-client.$REV-$SUBREV.tgz GNUmed-$REV/client GNUmed-$REV/install.sh GNUmed-$REV/GnuPublicLicense.txt GNUmed-$REV/check-prerequisites.py GNUmed-$REV/check-prerequisites.sh
