...
Section !$(Sec1Name) SEC01
  ...
  File "gnumed-head\gnumed\client\__init__.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\business"
  File "gnumed-head\gnumed\client\business\*.py"
  File "gnumed-head\gnumed\client\business\README"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\exporters"
  File "gnumed-head\gnumed\client\exporters\gmPatientExporter.py"
  File "gnumed-0-2-6-2\gnumed\client\exporters\__init__.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\wxGladeWidgets"
  File "gnumed-head\gnumed\client\wxGladeWidgets\*.py"
  File "gnumed-head\gnumed\client\wxGladeWidgets\__init__.py"  
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\importers"
  File "gnumed-head\gnumed\client\importers\gmLDTimporter.py"
  ...
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed"
  File "gnumed-head\gnumed\client\sitecustomize.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\wxpython"
  File "gnumed-head\gnumed\client\wxpython\*.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\wxpython\gui"
  File "gnumed-head\gnumed\client\wxpython\gui\*.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\wxpython\patient"
  File "gnumed-head\gnumed\client\wxpython\patient\*.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\wxpython"
  File "gnumed-head\gnumed\client\wxpython\__init__.py"
  SetOutPath "$INSTDIR\bin"
  File "gnumed-head\gnumed\client\wxpython\gnumed.py"
  SetOutPath "$INSTDIR"
  File "gnumed-head\gnumed\client\__init__.py"
  
  SetOutPath "$INSTDIR"
  File "gnumed-head\gnumed\client\gm-from-cvs.conf"
  Rename "$INSTDIR\gm-from-cvs.conf" "$INSTDIR\gnumed.conf"
  
  SetOutPath "$INSTDIR\bitmaps"
  File "gnumed-head\gnumed\client\wxpython\__init__.py"
  File "gnumed-head\gnumed\client\bitmaps\*.png"
  SetOutPath "$INSTDIR"
...
Section !$(Sec2Name) SEC02
  ...
  File "gnumed-head\gnumed\client\locale\de-gnumed.mo"
  ...
  File "gnumed-head\gnumed\client\locale\es-gnumed.mo"
  ...
  File "gnumed-head\gnumed\client\locale\fr-gnumed.mo"
...
Section !$(Sec3Name) SEC03
  ...
  ;File "gnumed-head\gnumed\client\doc\medical_knowledge\de\STIKO\STI_NEU.htm"
...
Section !$(Sec4Name) SEC04
  SetOutPath "$INSTDIR"
  File "gnumed-head\gnumed\client\connectors\gm_ctl_client.conf"
  File "gnumed-head\gnumed\client\connectors\gm_ctl_client-doc-viewer.conf"
  File "gnumed-head\gnumed\client\connectors\gm_ctl_client-doc-management.conf"
  SetOutPath "$INSTDIR\bin" 
  File "gnumed-head\gnumed\client\connectors\gm_ctl_client.py"
SectionEnd
