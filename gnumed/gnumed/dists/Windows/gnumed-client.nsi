...
Section !$(Sec1Name) SEC01
  ...
  File "gnumed-0-2-6-2\gnumed\client\__init__.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\business"
  File "gnumed-0-2-6-2\gnumed\client\business\*.py"
  File "gnumed-0-2-6-2\gnumed\client\business\README"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\exporters"
  File "gnumed-0-2-6-2\gnumed\client\exporters\gmPatientExporter.py"
  File "gnumed-0-2-6-2\gnumed\client\exporters\__init__.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\wxGladeWidgets"
  File "gnumed-0-2-6-2\gnumed\client\wxGladeWidgets\*.py"
  File "gnumed-0-2-6-2\gnumed\client\wxGladeWidgets\__init__.py"  
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\importers"
  File "gnumed-0-2-6-2\gnumed\client\importers\gmLDTimporter.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\pycommon"
  File "gnumed-0-2-6-2\gnumed\client\pycommon\*.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\pycommon\tools"
  File "gnumed-0-2-6-2\gnumed\client\pycommon\tools\*.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\pycommon"
  File "gnumed-0-2-6-2\gnumed\client\pycommon\__init__.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed"
  File "gnumed-0-2-6-2\gnumed\client\sitecustomize.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\wxpython"
  File "gnumed-0-2-6-2\gnumed\client\wxpython\*.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\wxpython\gui"
  File "gnumed-0-2-6-2\gnumed\client\wxpython\gui\*.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\wxpython\patient"
  File "gnumed-0-2-6-2\gnumed\client\wxpython\patient\*.py"
  SetOutPath "$PYTHON_PATH\Lib\site-packages\Gnumed\wxpython"
  File "gnumed-0-2-6-2\gnumed\client\wxpython\__init__.py"
  SetOutPath "$INSTDIR\bin"
  File "gnumed-0-2-6-2\gnumed\client\wxpython\gnumed.py"
  SetOutPath "$INSTDIR"
  File "gnumed-0-2-6-2\gnumed\client\__init__.py"
  
  SetOutPath "$INSTDIR"
  File "gnumed-0-2-6-2\gnumed\client\gm-from-cvs.conf"
  Rename "$INSTDIR\gm-from-cvs.conf" "$INSTDIR\gnumed.conf"
  
  SetOutPath "$INSTDIR\bitmaps"
  File "gnumed-0-2-6-2\gnumed\client\wxpython\__init__.py"
  File "gnumed-0-2-6-2\gnumed\client\bitmaps\*.png"
  SetOutPath "$INSTDIR"
  CreateDirectory "$SMPROGRAMS\GNUmed"
  CreateShortCut "$SMPROGRAMS\GNUmed\GNUmed.lnk" "$INSTDIR\bin\gnumed.py" "--conf-file=$INSTDIR\gnumed.conf --debug --override-schema-check $LANGGETTEXT"\
  "" 2 SW_SHOWNORMAL ALT|CTRL|G "This is the GNUmed reference client"
  CreateShortCut "$SMPROGRAMS\GNUmed\GNUmed(slave mode).lnk" "$INSTDIR\bin\gnumed.py" "--conf-file=$INSTDIR\gm-tm-slave.conf --debug --override-schema-check"\
...
Section !$(Sec2Name) SEC02
  ...
  File "gnumed-0-2-6-2\gnumed\client\locale\de-gnumed.mo"
  ...
  File "gnumed-0-2-6-2\gnumed\client\locale\es-gnumed.mo"
  ...
  File "gnumed-0-2-6-2\gnumed\client\locale\fr-gnumed.mo"
...
Section !$(Sec3Name) SEC03
  ...
  ;File "gnumed-0-2-6-2\gnumed\client\doc\medical_knowledge\de\STIKO\STI_NEU.htm"
...
Section !$(Sec4Name) SEC04
  SetOutPath "$INSTDIR"
  File "gnumed-0-2-6-2\gnumed\client\connectors\gm_ctl_client.conf"
  File "gnumed-0-2-6-2\gnumed\client\connectors\gm_ctl_client-doc-viewer.conf"
  File "gnumed-0-2-6-2\gnumed\client\connectors\gm_ctl_client-doc-management.conf"
  SetOutPath "$INSTDIR\bin" 
  File "gnumed-0-2-6-2\gnumed\client\connectors\gm_ctl_client.py"
SectionEnd
