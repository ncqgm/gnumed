...
-- --------------------------------------------------------------
\unset ON_ERROR_STOP
DELETE FROM ref.auto_hint WHERE url = 'http://www.startrek.com/database_article/denevan-neural-parasite';
\set ON_ERROR_STOP 1

insert into ref.auto_hint(query, hint, url, source, lang) values (
