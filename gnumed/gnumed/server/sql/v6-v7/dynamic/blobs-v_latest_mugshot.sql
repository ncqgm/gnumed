...
-- 
-- ==============================================================
-- $Id: blobs-v_latest_mugshot.sql,v 1.1 2007-06-11 19:36:20 ncq Exp $
-- $Revision: 1.1 $
...
-- --------------------------------------------------------------
select gm.log_script_insertion('$RCSfile: blobs-v_latest_mugshot.sql,v $', '$Revision: 1.1 $');

-- ==============================================================
-- $Log: blobs-v_latest_mugshot.sql,v $
-- Revision 1.1  2007-06-11 19:36:20  ncq
-- - new
--
