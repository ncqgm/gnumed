...
select into reply trans_str from i18n_trans, i18n_strings where i18n_strings.id = id_str and i18n_trans.code = lang_code and i18n_strings.str = $1;
if not found then
reply := $1;
