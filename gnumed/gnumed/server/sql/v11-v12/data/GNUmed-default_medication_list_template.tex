...
% License: GPL
%
% $Id: GNUmed-default_medication_list_template.tex,v 1.1 2009-12-22 10:11:06 ncq Exp $
% $Revision: 1.1 $
%------------------------------------------------------------------
...
\footnotetext{GNUmed EMR ($<client_version>$): Current medication list template}
