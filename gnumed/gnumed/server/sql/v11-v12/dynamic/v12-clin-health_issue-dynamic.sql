...
--
-- ==============================================================
-- $Id: v12-clin-health_issue-dynamic.sql,v 1.1 2009-08-28 12:45:26 ncq Exp $
-- $Revision: 1.1 $
...
-- --------------------------------------------------------------
comment on column clin.health_issue.diagnostic_certainty is
...
-- --------------------------------------------------------------
select gm.log_script_insertion('$RCSfile: v12-clin-health_issue-dynamic.sql,v $', '$Revision: 1.1 $');
