...
-- 
-- ==============================================================
-- $Id: v13-clin-v_test_results_journal.sql,v 1.1 2010-02-02 13:43:24 ncq Exp $
-- $Revision: 1.1 $
...
-- --------------------------------------------------------------
select gm.log_script_insertion('$RCSfile: v13-clin-v_test_results_journal.sql,v $', '$Revision: 1.1 $');

-- ==============================================================
-- $Log: v13-clin-v_test_results_journal.sql,v $
