...
-- 
-- ==============================================================
-- $Id: v11-clin-v_unified_test_types-dynamic.sql,v 1.1 2009-05-22 10:57:50 ncq Exp $
-- $Revision: 1.1 $
...
select
	...
	vmtt.pk_test_type_unified,
	vmtt.pk_lnk_ttype2unified_type
from
...
-- --------------------------------------------------------------
select gm.log_script_insertion('$RCSfile: v11-clin-v_unified_test_types-dynamic.sql,v $', '$Revision: 1.1 $');
