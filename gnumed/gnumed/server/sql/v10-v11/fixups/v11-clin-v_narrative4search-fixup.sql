...
-- 
-- ==============================================================
-- $Id: v11-clin-v_narrative4search-fixup.sql,v 1.1.2.1 2009-09-11 22:01:49 ncq Exp $
-- $Revision: 1.1.2.1 $
...
-- --------------------------------------------------------------
select gm.log_script_insertion('$RCSfile: v11-clin-v_narrative4search-fixup.sql,v $', '$Revision: 1.1.2.1 $');

-- ==============================================================
-- $Log: v11-clin-v_narrative4search-fixup.sql,v $
-- Revision 1.1.2.1  2009-09-11 22:01:49  ncq
-- - missing view
--
--