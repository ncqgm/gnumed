...
-- 
-- ==============================================================
-- $Id: v9-clin_coded_item_narrative.sql,v 1.1 2007-12-30 15:51:49 ncq Exp $
-- $Revision: 1.1 $
...
select
	...
	cn.code as code,
	cn.xfk_coding_system as coding_system,
	cn.pk as pk_coded_narrative,
	vn4s.pk_encounter,
	vn4s.pk_episode,
...
from
	clin.v_narrative4search vn4s
		inner join
	clin.coded_narrative cn
		on vn4s.narrative = cn.term
;
...
-- --------------------------------------------------------------
select gm.log_script_insertion('$RCSfile: v9-clin_coded_item_narrative.sql,v $', '$Revision: 1.1 $');

-- ==============================================================
-- $Log: v9-clin_coded_item_narrative.sql,v $
