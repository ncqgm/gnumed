...
-- 
-- ==============================================================
-- $Id: v9-clin-coded_item_narrative.sql,v 1.1 2007-12-30 21:06:54 ncq Exp $
-- $Revision: 1.1 $
...
-- --------------------------------------------------------------
select gm.log_script_insertion('$RCSfile: v9-clin-coded_item_narrative.sql,v $', '$Revision: 1.1 $');
