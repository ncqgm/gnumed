...
-- 
-- ==============================================================
-- $Id: v9-blobs-delete_document.sql,v 1.1.2.1 2009-01-18 13:10:02 ncq Exp $
-- $Revision: 1.1.2.1 $
...
-- --------------------------------------------------------------
select gm.log_script_insertion('$RCSfile: v9-blobs-delete_document.sql,v $', '$Revision: 1.1.2.1 $');

-- ==============================================================
-- $Log: v9-blobs-delete_document.sql,v $
-- Revision 1.1.2.1  2009-01-18 13:10:02  ncq
-- - need to explicitely delete doc parts as the FK is delete restrict
--
--