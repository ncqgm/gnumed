...
\setkomavar{fromaddress}{%
	...
	$2<if_not_empty::$<praxis_address::%(street)s::>$#2#$<praxis_address::%(street)s %(number)s::>$#2#::>2$$2<if_not_empty::$<praxis_address::%(subunit)s::>$#2# (%s)#2#::>2$$2<if_not_empty::$<praxis_address::%(street)s::>$#2#$<praxis_address::, %(postcode)s %(urb)s::>$#2#% no praxis address available::>2$
	$2<ph_cfg::argumentsdivider//DEFAULT//%% <%(name)s> set to [%(value)s]::>2$
}
\setkomavar{fromlogo}{%
	$<ph_cfg::argumentsdivider//#1#//%% <%(name)s> set to [%(value)s]::>$
	$2<ph_cfg::argumentsdivider//#2#//%% <%(name)s> set to [%(value)s]::>2$
	$2<if_not_empty::$<data_snippet::praxis-logo#1#\includegraphics[width=20mm]{%s}#1#image/png#1#.png::250>$#2#%s#2#$<qrcode::http://www.gnumed.de#1#\includegraphics[width=15mm]{%s}::>$	% no praxis logo available::>2$
	$2<ph_cfg::argumentsdivider//DEFAULT//%% <%(name)s> set to [%(value)s]::>2$
...
\setkomavar{subject}[]{%
	...
	$3<if_not_empty::$<<free_text::Betreff (Patientenstammdaten werden hinzugefügt)::120>>$#3#%s\\#3#% no additional Subject by user::>3$
	$3<ph_cfg::argumentsdivider//DEFAULT//%% <%(name)s> set to [%(value)s]::>3$
	$2<ph_cfg::argumentsdivider//#2#//%% <%(name)s> set to [%(value)s]::>2$
	Patient: $<title::::>$ $<firstname::::>$ $<lastname::::1>$\textsc{$<lastname::::2-99>$} (born $<date_of_birth::%d.%B %Y::>$)$<<if_not_empty::$<adr_street::home::>$#2#\\#2#::>2$
	...
	$<<ph_cfg::argumentsdivider//DEFAULT//%% <%(name)s> set to [%(value)s]::>2$
	\begin{itemize}
		\setlength\topsep{0pt}
...
\setkomavar{signature}{%
	$3<ph_cfg::argumentsdivider//#3#//%% <%(name)s> set to [%(value)s]::>3$
	$3<if_not_empty::$<<data_snippet::autograph-$<current_provider_lastnames::::>$_$<current_provider_firstnames::::>$//\includegraphics[width=30mm]{%s}//image/png//.png::250>>$#3#%s\\#3#% no signature file available::>3$
	$3<ph_cfg::argumentsdivider//DEFAULT//%% <%(name)s> set to [%(value)s]::>3$
...
% Anlagen
$3<ph_cfg::argumentsdivider//##//%% <%(name)s> set to [%(value)s]::>3$
