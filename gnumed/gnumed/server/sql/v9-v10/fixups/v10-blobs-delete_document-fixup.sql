...
-- 
-- ==============================================================
-- $Id: v10-blobs-delete_document-fixup.sql,v 1.1.2.1 2009-04-21 12:40:45 ncq Exp $
-- $Revision: 1.1.2.1 $
...
-- --------------------------------------------------------------
select gm.log_script_insertion('$RCSfile: v10-blobs-delete_document-fixup.sql,v $', '$Revision: 1.1.2.1 $');
