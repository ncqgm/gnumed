...
\begin{picture}(0,0)
	...
	% KVK-Daten
	$<text_snippet::GKV_KVK_Daten-Grünes_Rezept-LaTeX_picture_environment//%s::9999>$

	% Medikamente
	\multiputlist(\ganzlinks,-10)(0,-5)[l]{
	$<current_meds_for_rx::%(brand)s %(preparation)s (%(contains)s) [%(schedule)s]: %(amount2dispense)s;,::>$
	*************************************************,
	$<free_text::Hinweis zum Grünen Rezept::9999>$
	}

	% Stempel
	$<text_snippet::GKV_Stempel-LaTeX_picture_environment//%s::9999>$
