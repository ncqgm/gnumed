...
% KVK-Daten:
%\put(\ganzlinks,38){\texttt{$[Krankenkasse (von KVK/eGK)]$}}
...
%\put(\ganzlinks,10){\texttt{$[Krankenkassenummer (von KVK/eGK)]$}}
%\put(-56,10){\texttt{$[Versichertennummer (von KVK/eGK)]$}}
%\put(-22,10){\texttt{$[Versichertenstatus (von KVK/eGK)]$}}
%\put(\ganzlinks,2){\texttt{*KVKZa-KZVNr*}}
%\put(-49,2){\texttt{$[KVK/eGK gültig bis]$}}
...
-- --------------------------------------------------------------
select gm.log_script_insertion('v19-GKV_formatierte_KVK_Daten.sql', '19.0');
