...
-- --------------------------------------------------------------
drop index if exists clin.idx_test_type_loinc;

create index idx_test_type_loinc on clin.test_type(loinc);

-- --------------------------------------------------------------
drop index if exists clin.idx_test_result_unit;
...
alter table clin.test_type drop constraint if exists clin_test_type_uniq_name_per_org cascade;
...
alter table clin.test_type drop constraint if exists clin_test_type_uniq_abbrev_per_org cascade;
