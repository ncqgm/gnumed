...
-- 
-- ==============================================================
-- $Id: clin-adjust_soap_cat.sql,v 1.1.2.1 2008-01-04 12:52:50 ncq Exp $
-- $Revision: 1.1.2.1 $
...
-- --------------------------------------------------------------
select gm.log_script_insertion('$RCSfile: clin-adjust_soap_cat.sql,v $', '$Revision: 1.1.2.1 $');

-- ==============================================================
-- $Log: clin-adjust_soap_cat.sql,v $
-- Revision 1.1.2.1  2008-01-04 12:52:50  ncq
-- - check constraints can have different names
--
