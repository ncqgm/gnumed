...
-- 
-- ==============================================================
-- $Id: v8-blobs-delete_document.sql,v 1.1.2.1 2008-01-11 14:51:58 ncq Exp $
-- $Revision: 1.1.2.1 $
...
-- --------------------------------------------------------------
select gm.log_script_insertion('$RCSfile: v8-blobs-delete_document.sql,v $', '$Revision: 1.1.2.1 $');

-- ==============================================================
-- $Log: v8-blobs-delete_document.sql,v $
-- Revision 1.1.2.1  2008-01-11 14:51:58  ncq
-- - fix delete_document()
--
--