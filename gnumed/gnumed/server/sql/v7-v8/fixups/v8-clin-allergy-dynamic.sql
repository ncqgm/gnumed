...
-- 
-- ==============================================================
-- $Id: v8-clin-allergy-dynamic.sql,v 1.1.2.1 2008-08-17 08:17:18 ncq Exp $
-- $Revision: 1.1.2.1 $
...
-- --------------------------------------------------------------
select gm.log_script_insertion('$RCSfile: v8-clin-allergy-dynamic.sql,v $', '$Revision: 1.1.2.1 $');

-- ==============================================================
-- $Log: v8-clin-allergy-dynamic.sql,v $
-- Revision 1.1.2.1  2008-08-17 08:17:18  ncq
-- - see above
--
