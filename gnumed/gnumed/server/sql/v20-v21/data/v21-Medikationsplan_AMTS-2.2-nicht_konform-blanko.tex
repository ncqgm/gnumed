%------------------------------------------------------------------
% Medikationsplan gemäß AMTS 2.2 für GNUmed (http://www.gnumed.de)
%
...
%	showcrop,											% show crop marks
	...
	landscape,
	bindingoffset=0pt,
	nomarginpar,										% set marginpar/marginparsep to 0
	% do not include any margins/headers/footers into body calculation
	% in effect, this means that header/footer overlap into the margins
	ignoreall,
	headheight=40mm,
	headsep=0pt,
	footskip=0mm,
	left=8mm,right=8mm,top=55mm,bottom=18mm
}
	...
	\begin{tabular}[t]{p{12cm}p{16cm}}
		...
		{	% left side: Versionsinformationen
			...
			\parbox[t][1cm][t]{12cm}{
				...
				NICHT KONFORM zu: de-DE-Version 2.2
			}
		} & {
