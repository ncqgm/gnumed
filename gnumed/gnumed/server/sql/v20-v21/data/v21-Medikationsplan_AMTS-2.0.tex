...
\lohead{
	...
	%\begin{tabu} to \textwidth {p{7cm}|X[-1,L]|@{\hspace{1cm}}|X[-1,R]|p{4.6cm}}
	\begin{tabu} to \textwidth {p{7cm}X[-1,L]@{\hspace{1cm}}X[-1,R]p{4.3cm}}
		...
		&
			\includegraphics[valign=t,raise=6ex,max totalheight=4cm,max totalwidth=4cm,center]{$<<amts_png_file_current_page::::>>$}
		\tabularnewline
	\end{tabu}
}
%\lehead{test}
