...
% set lots of pdf* hyperref options
...
\lohead{
	...
	\begin{tabu} to \textwidth {>{\raggedleft\arraybackslash}p{7cm}@{\hspace{1.5mm}}X[-1,L]@{\hspace{1cm}}X[-1,R]p{4.3cm}}
		...
		&
			...
			\href{http://www.openstreetmap.org}{\mbox{$<praxis_address::%(street)s %(number)s %(subunit)s,%(postcode)s %(urb)s::55>$}} \newline
...
\embedfile[
	desc=LaTeX-Quellcode des Medikationsplans (übersetzbar mit "pdflatex -recorder -interaction=nonstopmode \currfilename\ "),
	mimetype=text/plain,
...
\IfFileExists{$<<amts_png_file_2::::>>$}{
	\embedfile[
		desc=QR-Code (Bild) für Seite 2,
		mimetype=image/png,
		ucfilespec=AMTS-QR-Code-Seite-2.png
	]{$<<amts_png_file_2::::>>$}
}{\typeout{[$<<amts_png_file_2::::>>$] not found}}

\IfFileExists{$<<amts_png_file_3::::>>$}{
	\embedfile[
		desc=QR-Code (Bild) für Seite 3,
		mimetype=image/png,
		ucfilespec=AMTS-QR-Code-Seite-3.png
	]{$<<amts_png_file_3::::>>$}
}{\typeout{[$<<amts_png_file_3::::>>$] not found}}

% data files from which QR codes were generated
\embedfile[
	desc=QR-Code (Daten) für Seite 1,
	mimetype=text/plain,
...
\IfFileExists{$<<amts_data_file_2::::>>$}{
	\embedfile[
		desc=QR-Code (Daten) für Seite 2,
		mimetype=text/plain,
		ucfilespec=AMTS-QR-Code-Daten-Seite-2.txt
	]{$<<amts_data_file_2::::>>$}
}{\typeout{[$<<amts_data_file_2::::>>$] not found}}

\IfFileExists{$<<amts_data_file_3::::>>$}{
	\embedfile[
		desc=QR-Code (Daten) für Seite 3,
		mimetype=text/plain,
		ucfilespec=AMTS-QR-Code-Daten-Seite-3.txt
	]{$<<amts_data_file_3::::>>$}
}{\typeout{[$<<amts_data_file_3::::>>$] not found}}

% VCF of creator
\IfFileExists{./praxis.vcf}{
	\embedfile[
		desc=digitale Visitenkarte des Erstellers des Medikationsplans,
		mimetype=text/vcf,
		ucfilespec=AMTS-Medikationsplan-Ersteller.vcf
	]{praxis.vcf}
}{\typeout{[praxis.vcf] not found}}
%------------------------------------------------------------------
