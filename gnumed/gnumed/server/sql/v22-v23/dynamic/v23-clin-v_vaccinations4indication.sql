...
drop view if exists clin.v_vaccinations4indication cascade;

create view clin.v_vaccinations4indication as
select
	c_enc.fk_patient
		as pk_patient,
	c_shot.pk
...
grant select on clin.v_vaccinations4indication to group "gm-doctors";

-- --------------------------------------------------------------
select gm.log_script_insertion('v23-clin-v_vaccinations4indication.sql', '23.0');
