...
-- 
-- ==============================================================
-- $Id: clin-encounter.sql,v 1.1.2.1 2007-04-07 14:57:50 ncq Exp $
-- $Revision: 1.1.2.1 $
...
-- --------------------------------------------------------------
select public.log_script_insertion('$RCSfile: clin-encounter.sql,v $', '$Revision: 1.1.2.1 $');

-- ==============================================================
-- $Log: clin-encounter.sql,v $
-- Revision 1.1.2.1  2007-04-07 14:57:50  ncq
-- - need to adjust clin.encounter started/last_affirmed before adding constraint
--
