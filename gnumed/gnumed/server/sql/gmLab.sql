...
CREATE TABLE lab_result (
	...
	result_date timestamp with timezone NOT NULL,
	value CHARACTER(15) NOT NULL,
	unit varchar(20) NOT NULL REFERENCES lab_unit (name),

	lab_abnormal_tag character(5),
	lab_comment TEXT,

	doc_abnormal_flag boolean,
	doc_comment TEXT
) INHERITS (audit_identity);
...
-- date/time sample was taken is in clinical_transaction->date
...
COMMENT ON COLUMN lab_result.lab_abnormal_tag IS
...
INSERT INTO schema_revision (filename, version) VALUES('$RCSfile: gmLab.sql,v $', '$Revision: 1.5 $');
