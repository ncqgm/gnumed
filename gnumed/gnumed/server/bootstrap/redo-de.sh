...
./bootstrap_gm_db_system.py --log-file=redo-de-core.log --conf-file=bootstrap-monolithic_core.conf
echo "****************************************"
echo "now adding database features for Germany"
rm -f redo-de-specific.log
./bootstrap_gm_db_system.py --log-file=redo-de-specific.log --conf-file=bootstrap-de.conf
