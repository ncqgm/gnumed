...
class wxgVaccinationEAPnl(wx.ScrolledWindow):
    def __init__(self, *args, **kwds):
        ...
        self._PRW_date_given = gmDateTimeInput.cDateInputPhraseWheel(self, wx.ID_ANY, "", style=wx.NO_BORDER)
        self._CHBOX_anamnestic = wx.CheckBox(self, wx.ID_ANY, _("Anamnestic"))
        self._PRW_vaccine = gmVaccWidgets.cVaccinePhraseWheel(self, wx.ID_ANY, "", style=wx.NO_BORDER)
        self._BTN_add_vaccine = wx.Button(self, wx.ID_ANY, _(" + "), style=wx.BU_EXACTFIT)
        self._TCTRL_indications = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.TE_MULTILINE | wx.TE_READONLY | wx.NO_BORDER)
        self._BTN_select_indications = wx.Button(self, wx.ID_ANY, _("Select"), style=wx.BU_EXACTFIT)
        self._PRW_batch = gmVaccWidgets.cBatchNoPhraseWheel(self, wx.ID_ANY, "", style=wx.NO_BORDER)
        self._PRW_episode = gmEMRStructWidgets.cEpisodeSelectionPhraseWheel(self, wx.ID_ANY, "", style=wx.NO_BORDER)
        self._PRW_site = gmPhraseWheel.cPhraseWheel(self, wx.ID_ANY, "", style=wx.NO_BORDER)
        self._PRW_provider = gmStaffWidgets.cProviderPhraseWheel(self, wx.ID_ANY, "", style=wx.NO_BORDER)
        self._PRW_reaction = gmPhraseWheel.cPhraseWheel(self, wx.ID_ANY, "", style=wx.NO_BORDER)
        ...
        self.Bind(wx.EVT_BUTTON, self._on_select_indications_button_pressed, self._BTN_select_indications)
    ...
    def __set_properties(self):
        ...
        self._BTN_select_indications.SetToolTipString(_("Select the indications this vaccination was given against."))
    ...
    def __do_layout(self):
        ...
        __szr_manage_button.Add(self._BTN_select_indications, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        __szr_manage_button.Add((20, 20), 1, wx.ALIGN_CENTER_VERTICAL, 0)
        _gszr_main.Add(__szr_manage_button, 1, wx.EXPAND, 0)
