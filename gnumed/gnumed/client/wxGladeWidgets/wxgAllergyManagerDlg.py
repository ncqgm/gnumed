...
class wxgAllergyManagerDlg(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self._BTN_dismiss_top = wx.Button(self, wx.ID_CLOSE, "", style=wx.BU_EXACTFIT)
        ...
        self.Bind(wx.EVT_BUTTON, self._on_dismiss_button_pressed, self._BTN_dismiss_top)
    ...
    def __set_properties(self):
        ...
        self._BTN_dismiss_top.SetToolTipString(_("Close the dialag. Will discard unsaved data."))
        self._BTN_dismiss_top.SetDefault()
    ...
    def __do_layout(self):
        ...
        __szr_state_button.Add((20, 20), 1, wx.EXPAND, 0)
        __szr_state_button.Add(self._BTN_dismiss_top, 0, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 0)
