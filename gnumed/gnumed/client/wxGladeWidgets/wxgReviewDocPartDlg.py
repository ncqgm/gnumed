#!/usr/bin/env python
# -*- coding: ISO-8859-15 -*-
# generated by wxGlade 0.4cvs on Mon Jun  5 11:17:15 2006

from Gnumed.wxpython import gmEMRStructWidgets, gmDateTimeInput
...
class wxgReviewDocPartDlg(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self._PhWheel_episode = gmEMRStructWidgets.cEpisodeSelectionPhraseWheel(self, -1, style=wx.HSCROLL | wx.NO_BORDER)
        self._SelBOX_doc_type = wx.Choice(self, -1, choices=[])
        self._TCTRL_doc_comment = wx.TextCtrl(self, -1, "", style=wx.HSCROLL|wx.NO_BORDER)
        self._PhWheel_doc_date = gmDateTimeInput.cFuzzyTimestampInput(self, -1, style=wx.HSCROLL|wx.NO_BORDER)
        self._TCTRL_reference = wx.TextCtrl(self, -1, "", style=wx.HSCROLL|wx.NO_BORDER)
    ...
    def __do_layout(self):
        ...
        __szr_grid_properties = wx.FlexGridSizer(5, 2, 2, 3)
        ...
        __szr_grid_properties.Add(self._SelBOX_doc_type, 0, wx.EXPAND, 0)
        __lbl_comment = wx.StaticText(self, -1, _("Comment"))
        __szr_grid_properties.Add(__lbl_comment, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        __szr_grid_properties.Add(self._TCTRL_doc_comment, 1, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 0)
