...
class wxgReviewDocPartDlg(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.__szr_top_staticbox = wx.StaticBox(self, -1, _("Reviews by others"))
    ...
    def __do_layout(self):
        ...
        __szr_box_review = wx.StaticBoxSizer(self.__szr_box_review_staticbox, wx.HORIZONTAL)
        ...
        __szr_episode.Add(__lbl_episode_picker, 0, wx.ALIGN_CENTER_VERTICAL|wx.ADJUST_MINSIZE, 5)
        __szr_episode.Add(self._PhWheel_episode, 1, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL|wx.ADJUST_MINSIZE, 5)
        __szr_main.Add(__szr_episode, 0, wx.ALL|wx.EXPAND|wx.ADJUST_MINSIZE, 5)
