...
class wxgVaccineEAPnl(wx.ScrolledWindow):
    def __init__(self, *args, **kwds):
        ...
        self._PRW_drug_product = gmSubstanceMgmtWidgets.cDrugProductPhraseWheel(self, wx.ID_ANY, "", style=wx.BORDER_NONE)
        self._CHBOX_fake = wx.CheckBox(self, wx.ID_ANY, _("Fake"))
        self._PRW_route = gmPhraseWheel.cPhraseWheel(self, wx.ID_ANY, "", style=wx.BORDER_NONE)
        self._CHBOX_live = wx.CheckBox(self, wx.ID_ANY, _("Live"))
        self._TCTRL_indications = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.BORDER_NONE | wx.TE_MULTILINE | wx.TE_READONLY)
        self._PRW_atc = gmATCWidgets.cATCPhraseWheel(self, wx.ID_ANY, "", style=wx.BORDER_NONE)
        self._PRW_age_min = gmPhraseWheel.cPhraseWheel(self, wx.ID_ANY, "", style=wx.BORDER_NONE)
        self._PRW_age_max = gmPhraseWheel.cPhraseWheel(self, wx.ID_ANY, "", style=wx.BORDER_NONE)
