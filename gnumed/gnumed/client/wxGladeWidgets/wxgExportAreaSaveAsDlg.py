...
class wxgExportAreaSaveAsDlg(wx.Dialog):
	def __init__(self, *args, **kwds):
		...
		self._BTN_select_directory = wx.Button(self, wx.ID_ANY, _("Path:"))
		...
		self._BTN_open_directory = wx.Button(self, wx.ID_ANY, _("Open"))
		self._BTN_clear_directory = wx.Button(self, wx.ID_ANY, _("Clear"))
