#!/usr/bin/env python
# -*- coding: utf-8 -*-
# generated by wxGlade 0.6.3 from "/home/ncq/Projekte/gm-git/gnumed/gnumed/client/wxg/wxgMeasurementEditAreaPnl.wxg"
...
class wxgMeasurementEditAreaPnl(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self._TCTRL_previous_value = wx.TextCtrl(self, -1, "", style=wx.TE_READONLY | wx.NO_BORDER)
    ...
    def __do_layout(self):
        ...
        __lbl_note_test_org = wx.StaticText(self, -1, _("Context"))
        ...
        _gszr_main.Add((20, 20), 0, wx.EXPAND, 0)
        __lbl_clinical_assessment = wx.StaticText(self, -1, _("Clinical details"))
        ...
        __lbl_narrative = wx.StaticText(self, -1, _("Comment"))
