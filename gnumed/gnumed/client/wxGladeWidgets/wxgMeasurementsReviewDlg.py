...
class wxgMeasurementsReviewDlg(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self._RBTN_abnormal = wx.RadioButton(self, -1, _("A&bnormal"))
        self._RBTN_confirm_relevance = wx.RadioButton(self, -1, _("Leave as is"), style=wx.RB_GROUP)
        self._RBTN_results_not_significant = wx.RadioButton(self, -1, _("Not relevant"))
        self._RBTN_results_significant = wx.RadioButton(self, -1, _("&Relevant"))
    ...
    def __set_properties(self):
        ...
        self._RBTN_abnormal.SetToolTipString(_("Select this if you think the selected results are technically abnormal - regardless of what the result provider said."))
        ...
        self._RBTN_results_not_significant.SetToolTipString(_("Select this if you think the selected results are clinically not significant."))
        self._RBTN_results_significant.SetToolTipString(_("Select this if you think the selected results are cliniccally significant."))
    ...
    def __do_layout(self):
        ...
        __szr_abnormal.Add(self._RBTN_abnormal, 0, wx.EXPAND, 0)
        __szr_review.Add(__szr_abnormal, 1, wx.EXPAND, 0)
        __szr_relevant.Add(self._RBTN_confirm_relevance, 0, wx.RIGHT|wx.EXPAND, 3)
        __szr_relevant.Add(self._RBTN_results_not_significant, 0, wx.LEFT|wx.RIGHT|wx.EXPAND, 3)
        __szr_relevant.Add(self._RBTN_results_significant, 0, wx.EXPAND, 3)
