...
class wxgEncounterEditAreaPnl(wx.ScrolledWindow):
    ...
    def __do_layout(self):
        ...
        __gszr_encounter_details.Add(self._PRW_rfe_codes, 0, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        __lbl_codes_aoe = wx.StaticText(self, -1, _("Codes"))
        __gszr_encounter_details.Add(__lbl_codes_aoe, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        __gszr_encounter_details.Add(self._PRW_aoe_codes, 0, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 0)
