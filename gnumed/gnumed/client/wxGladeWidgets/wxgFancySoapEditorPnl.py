...
class wxgFancySoapEditorPnl(wx.Panel):
	def __init__(self, *args, **kwds):
		...
		self._BTN_new_editor = wx.Button(self, wx.ID_ANY, _("&New"))
		self._BTN_clear_editor = wx.Button(self, wx.ID_ANY, _("&Clear"))
		self._BTN_discard_editor = wx.Button(self, wx.ID_ANY, _("&Discard"))
		self._BTN_save_note = wx.Button(self, wx.ID_ANY, _("&Save"))
		self._BTN_save_note_under = wx.Button(self, wx.ID_ANY, _("Save &under"))
		self._BTN_image = wx.Button(self, wx.ID_ANY, _("&Image"))
		self._BTN_save_encounter = wx.Button(self, wx.ID_ANY, _("Save"))
		self._BTN_save_all = wx.Button(self, wx.ID_ANY, _("Save &all"))
