...
class wxgReceiverSelectionDlg(wx.Dialog):
	def __init__(self, *args, **kwds):
		...
		__szr_final_address.Add(__LBL_receiver_heading, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
		...
		__szr_selections.Add(__szr_org_unit, 0, wx.BOTTOM | wx.EXPAND, 3)
		...
		self._LCTRL_candidates.Bind(wx.EVT_LIST_ITEM_SELECTED, self._on_candidate_selected)
		self._BTN_manage_orgs.Bind(wx.EVT_BUTTON, self._on_manage_orgs_button_pressed)
		self._BTN_OK.Bind(wx.EVT_BUTTON, self._on_ok_button_pressed)
		# end wxGlade
