...
class wxgSoapPluginPnl(wx.ScrolledWindow):
    def __init__(self, *args, **kwds):
        ...
        self._NB_soap_editors = cSoapNoteInputNotebook(self.__splitter_right_bottom_pnl, -1, style=0)
        self.__splitter_right_top_pnl = wx.ScrolledWindow(self._splitter_right, -1, style=wx.NO_BORDER)
        ...
        self._lbl_hints = wx.StaticText(self.__splitter_left_bottom_pnl, -1, _("In this area GNUmed will place hints and tips\nrelated to the current progress note and patient.\n\nThose hints will be derived from a variety of\nsources such as classifications (ICD, ...), expert\nsystems (EGADDS), online resources (Google\nand friends), drug databases, etc.\n\nEventually, those hints will be active in that you\ncan click on them and be taken to the relevant\ninformation/an appropriate action be performed."))
        self._TCTRL_recent_notes = wx.TextCtrl(self.__splitter_right_top_pnl, -1, _("In this area GNUmed will place the notes of the\nprevious encounter as well as notes by other\nstaff for the current encounter.\n\nNote that this may change depending on which\nactive problem is selected in the editor below."), style=wx.TE_MULTILINE|wx.TE_READONLY|wx.TE_WORDWRAP|wx.NO_BORDER)
        self._PRW_encounter_type = cEncounterTypePhraseWheel(self.__splitter_right_bottom_pnl, -1, "", style=wx.NO_BORDER)
        self._PRW_encounter_start = cFuzzyTimestampInput(self.__splitter_right_bottom_pnl, -1, "", style=wx.NO_BORDER)
        self._PRW_encounter_end = cFuzzyTimestampInput(self.__splitter_right_bottom_pnl, -1, "", style=wx.NO_BORDER)
        self._TCTRL_rfe = wx.TextCtrl(self.__splitter_right_bottom_pnl, -1, "", style=wx.NO_BORDER)
        self.notebook_1_pane_1 = wx.Panel(self._NB_soap_editors, -1)
        self._TCTRL_aoe = wx.TextCtrl(self.__splitter_right_bottom_pnl, -1, "", style=wx.NO_BORDER)
        self._BTN_save_all = wx.Button(self.__splitter_right_bottom_pnl, -1, _("&All"), style=wx.BU_EXACTFIT)
        self._BTN_save_encounter = wx.Button(self.__splitter_right_bottom_pnl, -1, _("&Encounter"), style=wx.BU_EXACTFIT)
        self._BTN_save_note = wx.Button(self.__splitter_right_bottom_pnl, -1, _("&Note"), style=wx.BU_EXACTFIT)
        self._BTN_new_editor = wx.Button(self.__splitter_right_bottom_pnl, -1, _("&New"), style=wx.BU_EXACTFIT)
        self._BTN_clear_editor = wx.Button(self.__splitter_right_bottom_pnl, -1, _("&Clear"), style=wx.BU_EXACTFIT)
        self._BTN_discard_editor = wx.Button(self.__splitter_right_bottom_pnl, -1, _("&Discard"), style=wx.BU_EXACTFIT)
    ...
    def __set_properties(self):
        ...
        self.__splitter_left_bottom_pnl.SetScrollRate(10, 10)
        self._TCTRL_recent_notes.Enable(False)
        self.__splitter_right_top_pnl.SetScrollRate(10, 10)
    ...
    def __do_layout(self):
        ...
        __szr_bottom_left.Add(self._lbl_hints, 0, wx.EXPAND, 0)
        ...
        __szr_top_right.Add(self._TCTRL_recent_notes, 1, wx.EXPAND, 0)
        self.__splitter_right_top_pnl.SetSizer(__szr_top_right)
        __lbl_encounter_details = wx.StaticText(self.__splitter_right_bottom_pnl, -1, _("Encounter"))
        ...
        __lbl_until = wx.StaticText(self.__splitter_right_bottom_pnl, -1, _("until"))
        ...
        __lbl_rfe = wx.StaticText(self.__splitter_right_bottom_pnl, -1, _("Request"))
        ...
        __szr_bottom_right.Add(__gszr_encounter_details, 0, wx.RIGHT|wx.EXPAND, 3)
        self._NB_soap_editors.AddPage(self.notebook_1_pane_1, _("tab1"))
        __szr_bottom_right.Add(self._NB_soap_editors, 1, wx.RIGHT|wx.TOP|wx.EXPAND, 3)
        __lbl_aoe = wx.StaticText(self.__splitter_right_bottom_pnl, -1, _("Summary"))
        ...
        __szr_bottom_right.Add(__szr_aoe, 0, wx.RIGHT|wx.TOP|wx.EXPAND, 3)
        __lbl_save = wx.StaticText(self.__splitter_right_bottom_pnl, -1, _("Save:"))
        ...
        __lbl_editor = wx.StaticText(self.__splitter_right_bottom_pnl, -1, _("Editor:"))
        ...
        __szr_buttons.Add((1, 1), 1, 0, 0)
        __szr_bottom_right.Add(__szr_buttons, 0, wx.RIGHT|wx.TOP|wx.EXPAND, 3)
