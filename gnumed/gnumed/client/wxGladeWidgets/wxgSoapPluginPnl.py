...
class wxgSoapPluginPnl(wx.ScrolledWindow):
    def __init__(self, *args, **kwds):
        ...
        self.__szr_soap_img_staticbox = wx.StaticBox(self.__splitter_soap_img_pnl, -1, _("Images"))
        ...
        self.__pnl_visual_soap = cVisualSoapPnl(self.__splitter_soap_img_pnl, -1, style=wx.NO_BORDER|wx.TAB_TRAVERSAL)
    ...
    def __do_layout(self):
        ...
        __szr_soap_img = wx.StaticBoxSizer(self.__szr_soap_img_staticbox, wx.HORIZONTAL)
        ...
        __szr_soap_img.Add(self.__pnl_visual_soap, 0, wx.EXPAND, 0)
