...
class wxgSoapPluginPnl(wx.ScrolledWindow):
    def __init__(self, *args, **kwds):
        ...
        self._BTN_save_note = wx.Button(self.__splitter_right_top_pnl, -1, _("&Notelet"), style=wx.BU_EXACTFIT)
    ...
    def __do_layout(self):
        ...
        __szr_buttons.Add(self._BTN_save_all, 0, wx.RIGHT|wx.EXPAND, 5)
