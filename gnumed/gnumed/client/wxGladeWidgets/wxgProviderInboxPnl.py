...
class wxgProviderInboxPnl(wx.ScrolledWindow):
	def __init__(self, *args, **kwds):
		...
		self._LCTRL_provider_inbox = cReportListCtrl(self, wx.ID_ANY, style=wx.LC_REPORT | wx.LC_SINGLE_SEL | wx.SIMPLE_BORDER)
		self._TXT_inbox_item_comment = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.TE_MULTILINE | wx.TE_READONLY | wx.HSCROLL | wx.TE_LINEWRAP | wx.TE_WORDWRAP)
	...
	def __set_properties(self):
		...
		self._RBTN_relevant_messages.SetToolTipString(_("Show relevant messages only (excludes expired and not-yet-due messages)."))
	...
	def __do_layout(self):
		...
		__szr_items.Add(self._RBTN_relevant_messages, 0, wx.RIGHT | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 5)
