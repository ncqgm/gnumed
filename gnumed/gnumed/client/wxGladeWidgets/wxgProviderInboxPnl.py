...
class wxgProviderInboxPnl(wx.ScrolledWindow):
    def __init__(self, *args, **kwds):
        ...
        self._CHBOX_active_patient = wx.CheckBox(self, -1, _("patient only"))
        self._CHBOX_active_provider = wx.CheckBox(self, -1, _("provider only"))
    ...
    def __do_layout(self):
        ...
        __lbl_items = wx.StaticText(self, -1, _("Show:"))
        ...
        __lbl_audience = wx.StaticText(self, -1, _("About active:"))
