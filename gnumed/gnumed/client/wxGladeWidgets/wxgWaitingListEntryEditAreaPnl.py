...
class wxgWaitingListEntryEditAreaPnl(wx.ScrolledWindow):
    def __init__(self, *args, **kwds):
        ...
        from Gnumed.wxpython import gmPhraseWheel, gmPatSearchWidgets
        ...
        self._PRW_comment = gmPhraseWheel.cPhraseWheel(self, -1, "", style=wx.NO_BORDER)
        self._PRW_zone = gmPatSearchWidgets.cWaitingZonePhraseWheel(self, -1, "", style=wx.NO_BORDER)
    ...
    def __set_properties(self):
        ...
        self._PRW_comment.SetToolTipString(_("What is the patient here for. Could be the Reason for Encounter."))
    ...
    def __do_layout(self):
        ...
        _gszr_main.Add(self._PRW_comment, 0, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 0)
