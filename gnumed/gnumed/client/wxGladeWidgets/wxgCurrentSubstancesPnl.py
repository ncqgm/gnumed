...
class wxgCurrentSubstancesPnl(wx.ScrolledWindow):
    def __init__(self, *args, **kwds):
        ...
        self._RBTN_issue = wx.RadioButton(self, -1, _("Health issue"))
        ...
        self._LBL_gfr = wx.StaticText(self, -1, _("GFR: ?"))
    ...
    def __do_layout(self):
        ...
        __szr_buttons.Add(self._LBL_gfr, 0, wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, 5)
