...
class wxgDataMiningPnl(wx.ScrolledWindow):
	def __init__(self, *args, **kwds):
		...
		self._BTN_run = wx.Button(self.splitter_top_panel, wx.ID_ANY, _("&Run"))
		self._BTN_clear = wx.Button(self.splitter_top_panel, wx.ID_ANY, _("Clear"))
		self._BTN_save = wx.Button(self.splitter_top_panel, wx.ID_ANY, _("Save"))
		self._BTN_delete = wx.Button(self.splitter_top_panel, wx.ID_ANY, _("Delete"))
		self._BTN_contribute = wx.Button(self.splitter_top_panel, wx.ID_ANY, _("Contribute"))
		self._BTN_visualize = wx.Button(self.splitter_top_panel, wx.ID_ANY, _("Plot"))
		self._BTN_waiting_list = wx.Button(self.splitter_top_panel, wx.ID_ANY, _("Wait.List"))
		self._BTN_save_results = wx.Button(self.splitter_top_panel, wx.ID_ANY, _("Save"))
		self._BTN_schema = wx.Button(self.splitter_top_panel, wx.ID_ANY, _("Schema"))
