...
class wxgDataMiningPnl(wx.ScrolledWindow):
	def __init__(self, *args, **kwds):
		...
		self._TCTRL_query = cTextCtrl(self.splitter_top_panel, wx.ID_ANY, "", style=wx.TE_MULTILINE | wx.TE_WORDWRAP | wx.NO_BORDER)
	...
	def __do_layout(self):
		...
		_szr_buttons.Add(self._BTN_waiting_list, 0, wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, 3)
