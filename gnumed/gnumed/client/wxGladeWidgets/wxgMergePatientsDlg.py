...
class wxgMergePatientsDlg(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self._TCTRL_patient1 = gmPatSearchWidgets.cPersonSearchCtrl(self, wx.ID_ANY, "", style=wx.NO_BORDER)
        self._TCTRL_patient1_details = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.TE_READONLY | wx.NO_BORDER)
        self._RBTN_patient1 = wx.RadioButton(self, wx.ID_ANY, _("Keep *this* patient"), style=wx.RB_USE_CHECKBOX)
        self._TCTRL_patient2 = gmPatSearchWidgets.cPersonSearchCtrl(self, wx.ID_ANY, "", style=wx.NO_BORDER)
        self._TCTRL_patient2_details = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.TE_READONLY | wx.NO_BORDER)
        self._RBTN_patient2 = wx.RadioButton(self, wx.ID_ANY, _("Keep *this* patient"), style=wx.RB_USE_CHECKBOX)
    ...
    def __do_layout(self):
        ...
        __szr_main.Add(__lbl_instructions, 0, wx.LEFT | wx.RIGHT | wx.TOP | wx.EXPAND, 5)
        __lbl_msg = wx.StaticText(self, wx.ID_ANY, _("Details of the patients to merge"))
        __szr_main.Add(__lbl_msg, 0, wx.LEFT | wx.RIGHT | wx.TOP | wx.ALIGN_CENTER_HORIZONTAL | wx.ALIGN_CENTER_VERTICAL, 5)
