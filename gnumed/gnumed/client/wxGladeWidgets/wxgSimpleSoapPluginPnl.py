...
class wxgSimpleSoapPluginPnl(wx.ScrolledWindow):
	def __init__(self, *args, **kwds):
		...
		self._BTN_add_problem = wx.Button(self.__pnl_left, wx.ID_ANY, _("&Add"))
		self._BTN_edit_problem = wx.Button(self.__pnl_left, wx.ID_ANY, _("&Edit"))
		self._BTN_delete_problem = wx.Button(self.__pnl_left, wx.ID_ANY, _("&Delete"))
		...
		self._BTN_save_soap = wx.Button(self.__pnl_left, wx.ID_ANY, _("&Save"))
		self._BTN_clear_soap = wx.Button(self.__pnl_left, wx.ID_ANY, _("&Clear"))
