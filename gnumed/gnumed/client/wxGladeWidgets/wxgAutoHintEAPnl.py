...
class wxgAutoHintEAPnl(wx.ScrolledWindow):
	...
	def __set_properties(self):
		...
		self._TCTRL_recommendation_query.SetToolTipString(_("Optional: The SQL query to be run for retrieving further information and perhaps a recommendation in case this automatic hint applies.\n\nMust return NULL or a string (TEXT).\n\nAny occurrence of ID_ACTIVE_PATIENT will be replaced by the internal GNUmed ID of the currently active patient."))
		...
		self._CHBOX_highlight.SetToolTipString(_("Whether or not to highlight this hint among others (where deemed appropriate)."))
		self._CHBOX_highlight.SetValue(1)
		self._RBTN_popup_none.SetToolTipString(_("Do not show this hint with a popup."))
		self._RBTN_popup_single.SetToolTipString(_("Show hint in individual popup."))
		self._RBTN_popup_multiple.SetToolTipString(_("Show hint with other hints in aggregate popup."))
