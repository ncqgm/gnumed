...
class wxgScanIdxPnl(wx.Panel):
	...
	def __set_properties(self):
		...
		self._PhWheel_source.SetToolTipString(_("Optional: The organization (unit) this document originates from (sender) or is intended for (receiver)."))
		self._RBTN_org_is_source.SetToolTipString(_("Select if the organization is the source of the document (the default)."))
		self._RBTN_org_is_source.SetValue(1)
		self._RBTN_org_is_receiver.SetToolTipString(_("Select if the organization is the receiver of the document.\n\nIn most cases this means that the document was created in this praxis and sent to the organization."))
