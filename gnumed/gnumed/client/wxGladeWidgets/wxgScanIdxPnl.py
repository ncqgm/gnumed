...
class wxgScanIdxPnl(wx.Panel):
	def __init__(self, *args, **kwds):
		...
		self._TBOX_description = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.BORDER_NONE | wx.TE_CHARWRAP | wx.TE_MULTILINE | wx.TE_WORDWRAP)
	...
	def __do_layout(self):
		...
		__szr_top_third.Add(__szr_top_left_btns, 0, wx.EXPAND | wx.LEFT, 5)
		...
		__szr_top_third.Add(__szr_top_right, 1, wx.EXPAND | wx.LEFT, 5)
		__szr_main.Add(__szr_top_third, 0, wx.EXPAND | wx.LEFT | wx.RIGHT, 5)
		...
		__szr_main.Add(__szr_bottom_third, 0, wx.BOTTOM | wx.EXPAND | wx.LEFT, 5)
