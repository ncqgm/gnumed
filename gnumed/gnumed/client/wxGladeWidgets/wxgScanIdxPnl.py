...
class wxgScanIdxPnl(wx.Panel):
    ...
    def __set_properties(self):
        ...
        self._TBOX_doc_date.SetToolTipString(_("Required: The date when the medical information described in the document was produced. This is free text so you can add approximate dates, too, such as 3/2004 where appropriate."))
