...
class wxgFamilyHistoryEAPnl(wx.ScrolledWindow):
    def __init__(self, *args, **kwds):
        ...
        #from Gnumed.wxpython.gmEMRStructWidgets import cMedicalConditionPhraseWheel
        ...
        self._PRW_relationship = cPhraseWheel(self, -1, "", style=wx.NO_BORDER)
        self._PRW_condition = cPhraseWheel(self, -1, "", style=wx.NO_BORDER)
        self._TCTRL_age_of_onset = wx.TextCtrl(self, -1, "", style=wx.NO_BORDER)
        self._PRW_age_of_death = cDateInputPhraseWheel(self, -1, "", style=wx.NO_BORDER)
    ...
    def __do_layout(self):
        ...
        __szr_condition_details.Add(self._TCTRL_age_of_onset, 0, wx.RIGHT|wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 5)
        __lbl_death = wx.StaticText(self, -1, _("Age death:"))
        __szr_condition_details.Add(__lbl_death, 0, wx.RIGHT|wx.ALIGN_CENTER_VERTICAL, 3)
        __szr_condition_details.Add(self._PRW_age_of_death, 0, wx.RIGHT|wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 5)
        __lbl_died_of_this = wx.StaticText(self, -1, _("Died of this:"))
        __szr_condition_details.Add(__lbl_died_of_this, 0, wx.RIGHT|wx.ALIGN_CENTER_VERTICAL, 3)
        __szr_condition_details.Add(self._PRW_died_of_this, 0, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 0)
