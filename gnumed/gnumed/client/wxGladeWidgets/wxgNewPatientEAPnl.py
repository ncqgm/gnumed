...
class wxgNewPatientEAPnl(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self._CHBOX_estimated_dob = wx.CheckBox(self, -1, _("Estimated"))
        ...
        self._TCTRL_unit = wx.TextCtrl(self, -1, "", style=wx.NO_BORDER)
    ...
    def __set_properties(self):
        ...
        self._CHBOX_estimated_dob.SetToolTipString(_("Check if the DOB is estimated rather than known precisely."))
        ...
        self._PRW_address_searcher.SetToolTipString(_("Optional address search: enter a postal code or street name to select a pre-existing address to auto-fill the fields below.\n\nBy editing the fields you can create a new address as needed."))
    ...
    def __do_layout(self):
        ...
        __fgsizer_details = wx.FlexGridSizer(22, 2, 3, 5)
        ...
        __vline_dob_sizer = wx.StaticLine(self, -1, style=wx.LI_VERTICAL)
        ...
        __lbl_address_heading = wx.StaticText(self, -1, _("Primary address and contact"), style=wx.ALIGN_CENTRE)
        ...
        __lbl_address_type = wx.StaticText(self, -1, _("Type"))
