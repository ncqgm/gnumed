...
class wxgCreatePatientMediaDlg(wx.Dialog):
	...
	def __set_properties(self):
		...
		self._CHBOX_generate_metadata.SetToolTip(wx.ToolTip(_("Check if you want GNUmed to generate and include metadata describing the exported patient data files.\n\nIf unchecked, export items will simply be dumped into the target directory.")))
		self._CHBOX_generate_metadata.SetValue(1)
	...
	def __do_layout(self):
		...
		__szr_main.Add(self._CHBOX_generate_metadata, 0, wx.ALIGN_CENTER_VERTICAL | wx.LEFT | wx.RIGHT | wx.TOP, 3)
