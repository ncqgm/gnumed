...
class wxgInboxMessageEAPnl(wx.ScrolledWindow):
    ...
    def __do_layout(self):
        ...
        __lbl_due = wx.StaticText(self, -1, _("Due"))
        _gszr_main.Add(__lbl_due, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        _gszr_main.Add(self._PRW_due, 0, wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
        __lbl_expires = wx.StaticText(self, -1, _("Expires"))
        _gszr_main.Add(__lbl_expires, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        _gszr_main.Add(self._PRW_expiry, 0, wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
