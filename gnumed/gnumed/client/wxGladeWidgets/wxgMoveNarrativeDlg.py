...
class wxgMoveNarrativeDlg(wx.Dialog):
    ...
    def __set_properties(self):
        ...
        self.SetSize(wx.DLG_SZE(self, (400, 400)))
    ...
    def __do_layout(self):
        ...
        __lbl_source_episode = wx.StaticText(self, -1, _("Source episode"))
        ...
        __lbl_narrative = wx.StaticText(self, -1, _("Narrative"))
        ...
        __lbl_target_episode = wx.StaticText(self, -1, _("Target episode"))
