...
class wxgFormTemplateEditAreaPnl(wx.ScrolledWindow):
	def __init__(self, *args, **kwds):
		...
		self._TCTRL_date_modified = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.NO_BORDER)
		self._TCTRL_modified_by = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.NO_BORDER)
	...
	def __do_layout(self):
		...
		__lbl_engine = wx.StaticText(self, wx.ID_ANY, _("Processed by:"))
		...
		__szr_options.Add(self._CHBOX_active, 0, wx.RIGHT | wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 5)
		__szr_options.Add(self._CHBOX_editable, 0, wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
		...
		__lbl_modified_when = wx.StaticText(self, wx.ID_ANY, _("Last modified:"))
		...
		__lbl_modified_by = wx.StaticText(self, wx.ID_ANY, _("by:"))
