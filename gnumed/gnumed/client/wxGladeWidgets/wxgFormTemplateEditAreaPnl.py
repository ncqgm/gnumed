...
class wxgFormTemplateEditAreaPnl(wx.ScrolledWindow):
    ...
    def __do_layout(self):
        ...
        sizer_1.Add(self._PRW_name_short, 2, wx.RIGHT|wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 5)
        __lbl_external_version = wx.StaticText(self, -1, _("Version:"))
        sizer_1.Add(__lbl_external_version, 0, wx.RIGHT|wx.ALIGN_CENTER_VERTICAL, 3)
        sizer_1.Add(self._TCTRL_external_version, 0, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 0)
        __gzsr_main.Add(sizer_1, 1, wx.EXPAND, 0)
