...
class wxgCardiacDevicePluginPnl(wx.ScrolledWindow):
	def __init__(self, *args, **kwds):
		...
		self._BTN_new_encounter = wx.Button(self.__splitter_right_top_pnl, wx.ID_ANY, _("New"))
		...
		self._BTN_save_all = wx.Button(self.__splitter_right_top_pnl, wx.ID_ANY, _("&All"))
		self._BTN_save_encounter = wx.Button(self.__splitter_right_top_pnl, wx.ID_ANY, _("&Encounter"))
		self._BTN_save_note = wx.Button(self.__splitter_right_top_pnl, wx.ID_ANY, _("&Note"))
		self._BTN_new_editor = wx.Button(self.__splitter_right_top_pnl, wx.ID_ANY, _("&New"))
		self._BTN_clear_editor = wx.Button(self.__splitter_right_top_pnl, wx.ID_ANY, _("&Clear"))
		self._BTN_discard_editor = wx.Button(self.__splitter_right_top_pnl, wx.ID_ANY, _("&Discard"))
