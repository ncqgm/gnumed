...
class wxgVisualSoapPnl(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.Bind(wx.EVT_LIST_ITEM_DESELECTED, self._on_visual_soap_deselected, self._LCTRL_visual_soaps)
    ...
    def __do_layout(self):
        ...
        __szr_episode.Add(__lbl_episode, 0, wx.RIGHT|wx.ALIGN_CENTER_VERTICAL, 3)
        __szr_episode.Add(self._PRW_episode, 1, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 5)
        __szr_img.Add(__szr_episode, 0, wx.EXPAND, 0)
        __szr_img.Add(self._IMG_soap, 1, wx.EXPAND, 3)
        __lbl_comment = wx.StaticText(self, -1, _("Comment:"))
        __szr_comment.Add(__lbl_comment, 0, wx.RIGHT|wx.ALIGN_CENTER_VERTICAL, 3)
        __szr_comment.Add(self._PRW_comment, 1, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 0)
        __szr_img.Add(__szr_comment, 0, wx.TOP|wx.EXPAND, 3)
        ...
        __szr_buttons.Add(self._LCTRL_visual_soaps, 1, wx.EXPAND, 0)
    ...
    def _on_visual_soap_deselected(self, event): # wxGlade: wxgVisualSoapPnl.<event_handler>
        print "Event handler `_on_visual_soap_deselected' not implemented"
        event.Skip()
