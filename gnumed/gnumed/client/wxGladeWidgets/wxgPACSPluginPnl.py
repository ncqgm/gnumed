...
class wxgPACSPluginPnl(wx.Panel):
	...
	def __set_properties(self):
		...
		self._LCTRL_details.SetBackgroundColour(wx.SystemSettings_GetColour(wx.SYS_COLOUR_BACKGROUND))
		...
		self._BMP_preview.SetMinSize(wx.DLG_SZE(self._BMP_preview, (50, 50)))
