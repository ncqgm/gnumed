...
class wxgCurrentMedicationEAPnl(wx.ScrolledWindow):
    def __init__(self, *args, **kwds):
        ...
        self._LBL_component = wx.StaticText(self, -1, _("Brand by component"))
        ...
        self._LBL_substance = wx.StaticText(self, -1, _("Unbranded substance"))
        ...
        self._DP_started = gmDateTimeInput.cDateInputPhraseWheel(self, -1, "", style=wx.NO_BORDER)
        self._CHBOX_approved = wx.CheckBox(self, -1, _("Approved of"))
        self._DP_discontinued = gmDateTimeInput.cDateInputPhraseWheel(self, -1, "", style=wx.NO_BORDER)
    ...
    def __do_layout(self):
        ...
        __gszr_main = wx.FlexGridSizer(14, 2, 1, 3)
        ...
        __gszr_main.Add(self._TCTRL_brand_ingredients, 0, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 0)
