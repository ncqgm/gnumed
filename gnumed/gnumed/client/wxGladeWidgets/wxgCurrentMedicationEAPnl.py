...
class wxgCurrentMedicationEAPnl(wx.ScrolledWindow):
    ...
    def __do_layout(self):
        ...
        __lbl_prep.SetForegroundColour(wx.Colour(255, 0, 0))
        _gszr_main.Add(__lbl_prep, 0, wx.ALIGN_CENTER_VERTICAL, 5)
        __szr_specs.Add(self._PRW_preparation, 1, wx.RIGHT|wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 10)
        __lbl_strength = wx.StaticText(self, -1, _("Strength"))
        __szr_specs.Add(__lbl_strength, 0, wx.RIGHT|wx.ALIGN_CENTER_VERTICAL, 5)
