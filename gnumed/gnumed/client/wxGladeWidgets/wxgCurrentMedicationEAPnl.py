...
class wxgCurrentMedicationEAPnl(wx.ScrolledWindow):
	def __init__(self, *args, **kwds):
		...
		self._BTN_heart = wx.Button(self, wx.ID_ANY, _(u"\u2665"))
		self._BTN_kidneys = wx.Button(self, wx.ID_ANY, _("Kidneys"))
		...
		self._BTN_discontinued_as_planned = wx.Button(self, wx.ID_ANY, _("Per plan"))
