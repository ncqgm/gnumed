#!/usr/bin/env python
# -*- coding: ISO-8859-15 -*-
# generated by wxGlade 0.4.1 on Sun Jan 14 22:34:16 2007
...
class wxg3ButtonQuestionDlg(wx.Dialog):
    ...
    def __do_layout(self):
        ...
        __szr_main.Add(self._LBL_question, 1, wx.ALL|wx.EXPAND, 3)
        __szr_buttons.Add(self._BTN_1, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        __szr_buttons.Add(self._BTN_2, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        __szr_buttons.Add((20, 20), 1, wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 0)
        __szr_buttons.Add(self._BTN_3, 0, wx.ALIGN_CENTER_VERTICAL, 0)
