...
class wxgEMRTimelinePluginPnl(wx.ScrolledWindow):
	def __init__(self, *args, **kwds):
		...
		self._BTN_export = wx.Button(self, wx.ID_SAVEAS, "")
	...
	def __set_properties(self):
		...
		self._BTN_export.SetToolTipString(_("Export timeline as SVG image."))
	...
	def __do_layout(self):
		...
		__szr_buttons.Add(self._BTN_export, 0, wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, 3)
	...
	def _on_export_button_pressed(self, event):  # wxGlade: wxgEMRTimelinePluginPnl.<event_handler>
