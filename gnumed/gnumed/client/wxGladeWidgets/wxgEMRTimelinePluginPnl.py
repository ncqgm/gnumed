...
class wxgEMRTimelinePluginPnl(wx.ScrolledWindow):
	def __init__(self, *args, **kwds):
		...
		self._BTN_zoom_in = wx.Button(self, wx.ID_ZOOM_IN, "")
		self._BTN_zoom_out = wx.Button(self, wx.ID_ZOOM_OUT, "")
		self._BTN_fit_care_period = wx.Button(self, wx.ID_ANY, _("Care"))
		self._BTN_fit_last_year = wx.Button(self, wx.ID_ANY, _("12 mo"))
		self._BTN_go2day = wx.Button(self, wx.ID_ANY, _("Today"))
		self._BTN_fit_all = wx.Button(self, wx.ID_ANY, _("All"))
