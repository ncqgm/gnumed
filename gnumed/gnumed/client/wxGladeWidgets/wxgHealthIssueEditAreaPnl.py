...
class wxgHealthIssueEditAreaPnl(wx.ScrolledWindow):
    ...
    def __do_layout(self):
        ...
        __gszr_main = wx.FlexGridSizer(4, 2, 3, 10)
        ...
        __szr_diagnosed.Add(__lbl_age, 0, wx.RIGHT|wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 5)
        ...
        __szr_diagnosed.Add(__lbl_year, 0, wx.RIGHT|wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 5)
