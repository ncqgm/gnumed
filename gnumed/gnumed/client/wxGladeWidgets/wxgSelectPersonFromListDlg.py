...
class wxgSelectPersonFromListDlg(wx.Dialog):
	def __init__(self, *args, **kwds):
		...
		self._LCTRL_persons = cReportListCtrl(self, wx.ID_ANY, style=wx.LC_REPORT | wx.LC_SINGLE_SEL | wx.LC_VRULES | wx.NO_BORDER)
	...
	def __do_layout(self):
		...
		_szr_buttons.Add((20, 20), 1, wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
...
if __name__ == "__main__":
	...
	dialog_1 = wxgSelectPersonFromListDlg(None, wx.ID_ANY, "")
