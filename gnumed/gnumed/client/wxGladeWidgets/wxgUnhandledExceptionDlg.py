...
class wxgUnhandledExceptionDlg(wx.Dialog):
	def __init__(self, *args, **kwds):
		...
		self._TCTRL_exc_type = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.TE_READONLY)
		self._TCTRL_exc_value = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.TE_READONLY)
	...
	def __set_properties(self):
		...
		self._TCTRL_helpdesk.SetBackgroundColour(wx.SystemSettings.GetColour(wx.SYS_COLOUR_BACKGROUND))
		self._TCTRL_helpdesk.SetToolTip(_("Find help on http://wiki.gnumed.de, too."))
		self._TCTRL_helpdesk.Enable(False)
		self._TCTRL_logfile.SetBackgroundColour(wx.SystemSettings.GetColour(wx.SYS_COLOUR_BACKGROUND))
		self._TCTRL_logfile.Enable(False)
		self._TCTRL_exc_type.SetBackgroundColour(wx.SystemSettings.GetColour(wx.SYS_COLOUR_BACKGROUND))
		self._TCTRL_exc_type.Enable(False)
		self._TCTRL_exc_value.SetBackgroundColour(wx.SystemSettings.GetColour(wx.SYS_COLOUR_BACKGROUND))
		self._TCTRL_exc_value.Enable(False)
		self._BTN_ok.SetToolTip(_("Close this dialog but keep running GNUmed."))
		self._BTN_ok.SetDefault()
		self._BTN_close.SetToolTip(_("Close this dialog AND the GNUmed client."))
