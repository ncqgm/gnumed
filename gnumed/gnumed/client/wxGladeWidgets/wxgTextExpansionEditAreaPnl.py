...
class wxgTextExpansionEditAreaPnl(wx.ScrolledWindow):
    def __init__(self, *args, **kwds):
        ...
        self._TCTRL_key_id = wx.TextCtrl(self, -1, "", style=wx.NO_BORDER)
    ...
    def __do_layout(self):
        ...
        __szr_file.Add(self._BTN_select_data_file, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        ...
        __lbl_key_id = wx.StaticText(self, -1, _("Key ID"))
        _gszr_main.Add(__lbl_key_id, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        _gszr_main.Add(self._TCTRL_key_id, 0, wx.EXPAND | wx.ALIGN_CENTER_VERTICAL, 0)
