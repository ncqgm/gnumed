...
class wxgBillEAPnl(wx.ScrolledWindow):
    def __init__(self, *args, **kwds):
        ...
        self._TCTRL_invoice_id = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.TE_READONLY | wx.NO_BORDER)
        self._PRW_close_date = cDateInputPhraseWheel(self, wx.ID_ANY, "", style=wx.NO_BORDER)
        self._TCTRL_address = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.TE_READONLY | wx.NO_BORDER)
        self._BTN_select_address = wx.Button(self, wx.ID_ANY, _("&Select"), style=wx.BU_EXACTFIT)
        self._TCTRL_value = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.TE_READONLY | wx.NO_BORDER)
        self._CHBOX_vat_applies = wx.CheckBox(self, wx.ID_ANY, _("&VAT applies"), style=wx.CHK_3STATE)
        self._TCTRL_value_with_vat = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.TE_READONLY | wx.NO_BORDER)
