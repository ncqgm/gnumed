...
# $Id: gmSOAPWidgets.py,v 1.94.2.1 2007-09-24 20:29:22 ncq Exp $
__version__ = "$Revision: 1.94.2.1 $"
...
# Revision 1.94.2.1  2007-09-24 20:29:22  ncq
# - when neither an existing episode is pre-selected nor rfe nor aoe entered
#   but still a soap note is to be saved don't choke on the empty episode name
#   but simply ask the user to provide one
#
