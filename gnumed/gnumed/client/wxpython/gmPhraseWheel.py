...
if __name__ == '__main__':
    ...
    class TestApp (wxApp):
	    ...
	    mp = cMatchProvider_FixedList(items)
            ...
            frame = wxFrame (None, -4, "phrase wheel test for GNUmed", size=wxSize(300, 300), style=wxDEFAULT_FRAME_STYLE|wxNO_FULL_REPAINT_ON_RESIZE)
