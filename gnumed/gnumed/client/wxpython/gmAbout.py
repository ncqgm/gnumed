...
class ScrollTxtWin (wxWindow):
	...
	def __init__ (self, parent):
		...
		self.changing_txt=wxStaticText(self, -1, "Hilmar Berger", size=(240,20))
	...
	def OnTimer(self, evt):
		self.changing_txt.MoveXY(self.__scroll_ctr, 0)
		self.__scroll_ctr=self.__scroll_ctr+1
		if(self.__scroll_ctr>253):
			self.__scroll_ctr=0
...
\xe9$\xf5\x07\x95\x0cD\x95t:\xb1\x92\xae\x9cI\xa8~\x84\x1f\xe0\xa3ec'
	...
	def OnClose (self, event):
		###self.timer.Stop ()
		#ScrollTxtWin.timer.Stop()   # FIX THIS?
		self.Destroy ()
