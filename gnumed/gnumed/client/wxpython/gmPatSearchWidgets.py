...
# $Id: gmPatSearchWidgets.py,v 1.128.2.1 2009-12-10 10:02:34 ncq Exp $
__version__ = "$Revision: 1.128.2.1 $"
...
# Revision 1.128.2.1  2009-12-10 10:02:34  ncq
# - really don't add to waiting list if no active patient
#
