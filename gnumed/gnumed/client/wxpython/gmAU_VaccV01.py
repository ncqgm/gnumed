...
class cAU_VaccV01Panel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.window_2 = wx.SplitterWindow(self.notebook_1_pane_1, -1, style=wx.SP_3D|wx.SP_BORDER)
        self.window_3 = wx.SplitterWindow(self.window_2, -1, style=wx.SP_3D|wx.SP_BORDER)
    ...
    def __do_layout(self):
        ...
        sizer_22.Add(self.checkbox_1, 0, wx.ADJUST_MINSIZE, 1)
        sizer_2.Add(sizer_22, 1, wx.EXPAND, 0)
        sizer_16.Add(sizer_2, 1, wx.EXPAND, 0)
        sizer_16.Add(self.label_9, 0, wx.ADJUST_MINSIZE, 0)
        sizer_16.Add(self.text_ctrl_1, 2, wx.ADJUST_MINSIZE, 0)
        grid_sizer_1.Add(sizer_16, 1, wx.EXPAND, 0)
        grid_sizer_1.Add(self.label_4, 0, wx.ADJUST_MINSIZE, 0)
        sizer_6.Add(self.checkbox_dtpa, 0, wx.ADJUST_MINSIZE, 0)
        sizer_6.Add(self.checkbox_2_ipv, 0, wx.ADJUST_MINSIZE, 0)
        sizer_6.Add(self.checkbox_paed_hepb, 0, wx.ADJUST_MINSIZE, 0)
        sizer_6.Add(self.checkbox_hib, 0, wx.ADJUST_MINSIZE, 0)
        sizer_6.Add(self.checkbox_7pneumo, 0, wx.ADJUST_MINSIZE, 0)
        sizer_5.Add(sizer_6, 1, wx.EXPAND, 0)
        sizer_7.Add(self.checkbox_varicella, 0, wx.ADJUST_MINSIZE, 0)
        sizer_7.Add(self.checkbox_mmr, 0, wx.ADJUST_MINSIZE, 0)
        sizer_7.Add(self.checkbox_mening_c, 0, wx.ADJUST_MINSIZE, 0)
        sizer_7.Add(self.checkbox_tick_enceph, 0, wx.ADJUST_MINSIZE, 0)
        sizer_5.Add(sizer_7, 1, wx.EXPAND, 0)
        sizer_5.Add(self.static_line_1, 0, wx.EXPAND, 0)
        sizer_15.Add(self.checkbox_opv, 0, wx.ADJUST_MINSIZE, 0)
        ...
        sizer_8.Add(self.checkbox_Dtpa, 0, wx.ADJUST_MINSIZE, 0)
        sizer_8.Add(self.checkbox_ADT, 0, wx.ADJUST_MINSIZE, 0)
        sizer_8.Add(self.checkbox_tettox, 0, wx.ADJUST_MINSIZE, 0)
        sizer_5.Add(sizer_8, 1, wx.EXPAND, 0)
        sizer_5.Add(self.static_line_2, 0, wx.EXPAND, 0)
        sizer_9.Add(self.checkbox_23vpneum, 0, wx.ADJUST_MINSIZE, 0)
        sizer_9.Add(self.checkbox_influenza, 0, wx.ADJUST_MINSIZE, 0)
        sizer_5.Add(sizer_9, 1, wx.EXPAND, 0)
        sizer_5.Add(self.static_line_3, 0, wx.EXPAND, 0)
        sizer_10.Add(self.checkbox_paed_hepa, 0, wx.ADJUST_MINSIZE, 0)
        sizer_10.Add(self.checkbox_adult_hepa, 0, wx.ADJUST_MINSIZE, 0)
        sizer_10.Add(self.checkbox_adult_hepb, 0, wx.ADJUST_MINSIZE, 0)
        sizer_5.Add(sizer_10, 1, wx.EXPAND, 0)
        sizer_12.Add(self.checkbox_typhoid, 0, wx.ADJUST_MINSIZE, 0)
        sizer_12.Add(self.checkbox_mening_acwy, 0, wx.ADJUST_MINSIZE, 0)
        sizer_12.Add(self.checkbox_yellow_fever, 0, wx.ADJUST_MINSIZE, 0)
        sizer_12.Add(self.checkbox_cholera, 0, wx.ADJUST_MINSIZE, 0)
        sizer_5.Add(sizer_12, 1, wx.EXPAND, 0)
        sizer_5.Add(self.static_line_4, 0, wx.EXPAND, 0)
        sizer_13.Add(self.checkbox_rabies, 0, wx.ADJUST_MINSIZE, 0)
        sizer_13.Add(self.checkbox_japan_enceph, 0, wx.ADJUST_MINSIZE, 0)
        sizer_13.Add(self.checkbox_qfever, 0, wx.ADJUST_MINSIZE, 0)
        ...
        sizer_11.Add(self.combo_box_2, 0, wx.ADJUST_MINSIZE, 0)
        ...
        sizer_4.Add(self.button_1, 0, wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL|wx.ADJUST_MINSIZE, 0)
