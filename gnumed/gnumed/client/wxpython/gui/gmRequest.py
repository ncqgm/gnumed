...
class RequestsPanel(wx.Panel):
    def __init__(self, *args, **kwds):
        ...
        self.label_2 = wx.StaticText(self, -1, _("Form"))
        self.wheel_form = cPhraseWheel(self, -1, "")
        self.label_3 = wx.StaticText(self, -1, _("Request"))
        self.text_ctrl_request = wx.TextCtrl(self, -1, "")
        self.label_4 = wx.StaticText(self, -1, _("Clinical"))
        self.text_ctrl_clinical = wx.TextCtrl(self, -1, "", style=wx.TE_PROCESS_ENTER|wx.TE_MULTILINE)
        self.label_5 = wx.StaticText(self, -1, _("Instructions"))
    ...
    def __do_layout(self):
        ...
        grid_sizer_1.Add(self.wheel_type, 0, wx.EXPAND, 0)
        grid_sizer_1.Add(self.label_2, 0, 0, 0)
        grid_sizer_1.Add(self.wheel_form, 0, wx.EXPAND, 0)
        grid_sizer_1.Add(self.label_3, 0, 0, 0)
        grid_sizer_1.Add(self.text_ctrl_request, 0, wx.EXPAND, 0)
        grid_sizer_1.Add(self.label_4, 0, 0, 0)
        grid_sizer_1.Add(self.text_ctrl_clinical, 0, wx.EXPAND, 0)
        grid_sizer_1.Add(self.label_5, 0, 0, 0)
        grid_sizer_1.Add(self.text_ctrl_instructions, 0, wx.EXPAND, 0)
        grid_sizer_1.AddGrowableRow(3)
        grid_sizer_1.AddGrowableRow(4)
        grid_sizer_1.AddGrowableCol(1)
        sizer_1.Add(grid_sizer_1, 1, wx.EXPAND, 0)
        sizer_1.Add(self.button_OK, 0, wx.ALIGN_CENTER_HORIZONTAL, 0)
