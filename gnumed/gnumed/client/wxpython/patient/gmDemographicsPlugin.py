...
# @TODO:
############################################################################
# $Source: /home/ncq/Projekte/cvs2git/vcs-mirror/gnumed/gnumed/client/wxpython/patient/Attic/gmDemographicsPlugin.py,v $
# $Id: gmDemographicsPlugin.py,v 1.1 2003-11-03 23:57:20 ncq Exp $
...
#============================================================
class gmDemographicsPlugin(gmPlugin.wxBasePlugin):
...
if __name__ == "__main__":
	...
	app.MainLoop()
#----------------------------------------------------------------------
# $Log: gmDemographicsPlugin.py,v $
# Revision 1.1  2003-11-03 23:57:20  ncq
# - rename to avoid namespace conflict with business object
#
