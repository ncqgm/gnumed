...
class gmGP_Referrals (gmPlugin.wxPatientPlugin):
	...
	"""
	__icons = {
"""outgoing letter""": "x\xda]\xcd;\x0e\x830\x10\x04\xd0\x9eSXJ\xe1T+\\$r\x9dH.\xe3\x82f[\x84R\x05e\
...
"""writing pen""": 'x\xda\x8d\x901\x0b\xc3 \x10\x85\xf7\xfc\x8a\x83\x0e\x16\x02\x8ff\xa97+d\x8c\
...
\x12^\x04\x14P\xa7'
	...
	def GetIconData(self, anIconID = None):
		if anIconID == None:
			return self.__icons["""outgoing letter"""]
		else:
