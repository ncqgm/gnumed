...
class TextBox_BlackNormal(wx.TextCtrl):
	def __init__ (self, parent, id): #, wx.DefaultPostion, wx.DefaultSize):
		...
		self.SetFont(wx.Font(12,wx.SWISS,wx.NORMAL, wx.BOLD,False,''))
#------------------------------------------------------------
class PatientsPanel(wx.Panel, gmDataPanelMixin.DataPanelMixin):
	def __init__(self, parent, plugin, id=wx.NewId ()):
		wx.Panel.__init__(self, parent, id ,wx.DefaultPosition,wx.DefaultSize,wx.RAISED_BORDER|wx.TAB_TRAVERSAL)
		...
		self.addresslist = wx.ListBox(self,ID_NAMESLIST,wx.DefaultPosition,wx.DefaultSize,addressdata,wx.LB_SINGLE)
		self.addresslist.SetFont(wx.Font(12,wx.SWISS, wx.NORMAL, wx.NORMAL, False, '')) #first list with patient names
		self.addresslist.SetForegroundColour(wx.Color(180,182,180))
		# code to link up SQLListControl
		self.patientslist = gmSQLListControl.SQLListControl (self, ID_PATIENTSLIST, hideid=True, style= wx.LC_REPORT|wx.LC_NO_HEADER|wx.SUNKEN_BORDER)
		self.patientslist.SetFont(wx.Font(12,wx.SWISS, wx.NORMAL, wx.NORMAL, False, '')) #first list with patient names
		...
		self.combo_relationship = wx.ComboBox(self, 500, "", wx.DefaultPosition,wx.DefaultSize, ['Father','Mother'], wx.CB_DROPDOWN)
		self.txt_surname = TextBox_RedBold(self,-1)
		self.combo_title = wx.ComboBox(self, 500, "", wx.DefaultPosition,wx.DefaultSize,self.titlelist, wx.CB_DROPDOWN)
		self.txt_firstname = TextBox_RedBold(self,-1)
		self.combo_sex = wx.ComboBox(self, 500, "", wx.DefaultPosition,wx.DefaultSize, ['M','F'], wx.CB_DROPDOWN)
		self.cb_preferredname = wx.CheckBox(self, -1, _("Preferred Name"), wx.DefaultPosition,wx.DefaultSize, wx.NO_BORDER)
		self.txt_preferred = TextBox_RedBold(self,-1)
		self.txt_address = wx.TextCtrl(self, 30, "",
					      wx.DefaultPosition,wx.DefaultSize, style=wx.TE_MULTILINE|wx.NO_3D|wx.SIMPLE_BORDER)
		self.txt_address.SetInsertionPoint(0)
		self.txt_address.SetFont(wx.Font(12,wx.SWISS, wx.NORMAL, wx.NORMAL, False, ''))
		...
		self.combo_maritalstatus = wx.ComboBox(self, 500, "", wx.DefaultPosition,wx.DefaultSize,
						      ['single','married'], wx.CB_DROPDOWN)
		self.txt_occupation = TextBox_BlackNormal(self,-1)
		self.txt_countryofbirth = TextBox_BlackNormal(self,-1)
		self.btn_browseNOK = wx.Button(self,-1,"Browse NOK") #browse database to pick next of Kin
		self.txt_nameNOK = wx.TextCtrl(self, 30,
					      "Peter Smith \n"
					      "22 Lakes Way \n"
					      "Valentine 2280",
					      wx.DefaultPosition,wx.DefaultSize, style=wx.TE_MULTILINE|wx.NO_3D|wx.SIMPLE_BORDER)
		self.txt_nameNOK.SetInsertionPoint(0)
		self.txt_nameNOK.SetFont(wx.Font(12,wx.SWISS, wx.NORMAL, wx.NORMAL, False, ''))
		...
		#----------------------
		self.cb_addressresidence = wx.CheckBox(self, -1, " Residence ", wx.DefaultPosition,wx.DefaultSize, wx.NO_BORDER)
		self.cb_addresspostal = wx.CheckBox(self, -1, " Postal ", wx.DefaultPosition,wx.DefaultSize, wx.NO_BORDER)
		#--------------------
		# create the buttons
		#--------------------
		self.btn_photo_import= wx.Button(self,-1,"Import")
		self.btn_photo_export = wx.Button(self,-1,"Export")
		self.btn_photo_aquire = wx.Button(self,-1,"Acquire")
		#-------------------------------------------------------
		#Add the each line of controls to a horizontal box sizer
		#-------------------------------------------------------
		self.sizer_line0_left = wx.BoxSizer(wx.HORIZONTAL)
		#line one:surname, title
		self.sizer_line1_left = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line1_left.Add(self.lbl_surname,3, wx.GROW|wx.ALIGN_CENTER_VERTICAL,5)
		self.sizer_line1_left.Add(self.txt_surname,7,wx.EXPAND)
		self.sizer_line1_left.Add(0,0,1)
		self.sizer_line1_left.Add(self.lbl_title,2,wx.ALIGN_CENTER_VERTICAL, 5)
		self.sizer_line1_left.Add(self.combo_title,4,wx.EXPAND)
		#line two:firstname, sex
		self.sizer_line2_left = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line2_left.Add(self.lbl_firstname,3,wx.GROW|wx.ALIGN_CENTER_VERTICAL,5)
		self.sizer_line2_left.Add(self.txt_firstname,7,wx.EXPAND)
		self.sizer_line2_left.Add(0,0,1)
		self.sizer_line2_left.Add(self.lbl_sex,2,wx.GROW|wx.ALIGN_CENTER_VERTICAL,5)
		self.sizer_line2_left.Add(self.combo_sex,4,wx.EXPAND)
		#line three:preferred salutation
		self.sizer_line3_left = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line3_left.Add(self.lbl_preferredname,3,wx.GROW|wx.ALIGN_CENTER_VERTICAL,5)
		self.sizer_line3_left.Add(self.txt_preferred,7,wx.EXPAND)
		self.sizer_line3_left.Add(1,0,7)
		#line four: preferred alias
		self.sizer_line4_left = wx.BoxSizer(wx.HORIZONTAL)
		...
		self.sizer_line6_left = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line6_left.Add(self.lbl_line6gap,1,wx.EXPAND)
		#----------------
		#3:street details
		#a) the label
		sizer_lblstreet = wx.BoxSizer(wx.VERTICAL)
		sizer_lblstreet.Add(self.lbl_street,1, wx.EXPAND)
		#--------------------
		#3:street details
		#b) multiline textbox
		#-------------------
		self.sizer_line7_left = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line7_left.Add(0,0,1)
		#------------------------------
		#3:street details
		#c) residence or postal address
		#------------------------------
		sizer_respostal = wx.BoxSizer(wx.VERTICAL)
		...
		self.sizer_line7_left = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line7_left.Add(sizer_lblstreet,3,wx.ALIGN_CENTER_VERTICAL,5)
		...
		#--------------------------
		self.sizer_line8_left = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line8_left.Add(self.lbl_suburb,3,wx.ALIGN_CENTER_VERTICAL,5)
		self.sizer_line8_left.Add(self.txt_suburb,7,wx.EXPAND)
		self.sizer_line8_left.Add(0,0,1)
		self.sizer_line8_left.Add(self.lbl_zip,3,wx.ALIGN_CENTER_VERTICAL,5)
		self.sizer_line8_left.Add(self.txt_zip,3,wx.EXPAND)
		#--------------------------------
		# create the multiple address box
		#--------------------------------
		self.sizer_line9_left = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line9_left.Add(self.lbl_address_s,3,wx.ALIGN_CENTER_VERTICAL,5)
		...
		#-------------------------------------------------------------------------
		self.leftside = wx.BoxSizer(wx.VERTICAL)
		...
		#---------------------------------------------------
		self.sizer_line0_right = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line1_right = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line2_right = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line3_right = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line4_right = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line5_right = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line6_right = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line7_right = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line8_right = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line9_right = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line10_right = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_line11_right = wx.BoxSizer(wx.HORIZONTAL)
		#line1 _ birthdate, maritial status
		self.sizer_line1_right.Add(self.lbl_birthdate,2,wx.ALIGN_CENTER_VERTICAL,0)
		self.sizer_line1_right.Add(self.txt_birthdate,2,wx.ALIGN_LEFT)
		self.sizer_line1_right.Add(self.lbl_maritalstatus,2,wx.ALIGN_CENTRE,0)
		self.sizer_line1_right.Add(self.combo_maritalstatus, 2, wx.ALIGN_CENTER_VERTICAL,0)
		#line2 - occupation (use word wheel later in place of text box)
		self.sizer_line2_right.Add(self.lbl_occupation,2,wx.ALIGN_CENTER_VERTICAL,0)
		self.sizer_line2_right.Add(self.txt_occupation,6,wx.EXPAND)
		#line3 - country of birth (use word wheel later)
		self.sizer_line3_right.Add(self.lbl_birthplace,2,wx.ALIGN_CENTER_VERTICAL,0)
		self.sizer_line3_right.Add(self.txt_countryofbirth,6,wx.EXPAND)
		#line 4 - next of kin + browse for next of kin
		self.sizer_line4_right.Add(self.lbl_nextofkin, 2,wx.ALIGN_CENTER_VERTICAL,0)
		self.sizer_line4_right.Add(self.btn_browseNOK,2, wx.ALIGN_CENTER_VERTICAL)
		#self.sizer_line4_right.Add(0,0,1)
		self.sizer_line4_right.Add(self.lbl_relationship,2, wx.ALIGN_CENTER_VERTICAL,0)
		self.sizer_line4_right.Add(self.combo_relationship,2,wx.EXPAND)
		#name of next of kin
		self.sizer_gap_vertical =wx.BoxSizer(wx.VERTICAL)
		...
		# next to this
		#----------------------------------------------------------------------------
		self.sizer_contacts = wx.BoxSizer(wx.VERTICAL)
		self.sizer_line6_right.Add(self.lbl_homephone, 3,wx.ALIGN_CENTRE,0)
		...
		self.sizer_line7_right.Add(self.lbl_workphone,3,wx.ALIGN_CENTRE,0)
		...
		self.sizer_line8_right.Add(self.lbl_fax,3,wx.ALIGN_CENTRE,0)
		...
		self.sizer_line9_right.Add(self.lbl_email,3,wx.ALIGN_CENTRE,0)
		...
		self.sizer_line10_right.Add(self.lbl_web,3,wx.ALIGN_CENTRE,0)
		...
		self.sizer_line11_right.Add(self.lbl_mobile,3,wx.ALIGN_CENTRE,0)
		...
		self.sizer_photo = wx.BoxSizer(wx.VERTICAL)
#		self.patientpicture = gmGP_PatientPicture.cPatientPicture(self, -1)
		self.sizer_photo.Add(self.patientpicture,3,wx.ALIGN_CENTER_HORIZONTAL,0)
		self.sizer_photo.Add(self.btn_photo_aquire,1,wx.ALIGN_CENTER_HORIZONTAL,0)
		self.sizer_photo.Add(self.btn_photo_export,1,wx.ALIGN_CENTER_HORIZONTAL,0)
		self.sizer_photo.Add(self.btn_photo_import,1,wx.ALIGN_CENTER_HORIZONTAL,0)
		self.sizer_contactsandphoto  = wx.BoxSizer(wx.HORIZONTAL)
		self.sizer_contactsandphoto.AddSizer(self.sizer_contacts,6,wx.ALIGN_CENTER_VERTICAL,0)
		self.sizer_contactsandphoto.AddSizer(self.sizer_photo,2,wx.ALIGN_CENTER_VERTICAL,0)
		...
		self.sizerunder = wx.BoxSizer(wx.HORIZONTAL)
...
#============================================================
#class gmDemographics(gmPlugin.wx.BasePlugin):
