...
class BMI_Colour_Scale(wxWindow):
	...
	def Draw(self,dc):
		...
		te = dc.GetTextExtent("Underweight")
		dc.DrawText("Underweight", 20,9)
		#------------------------------------------
		...
		dc.SetFont(wxFont(8, wxSWISS, wxNORMAL, wxNORMAL))
		dc.SetTextForeground(wxColour(0,0,0))
		te = dc.GetTextExtent("63< Normal >79")
		dc.DrawText("63 - Normal - 79",95,8)
		#------------------------------------------
		...
		dc.SetFont(wxFont(8, wxSWISS, wxNORMAL, wxNORMAL))
		dc.SetTextForeground(wxColour(0,0,0))
		te = dc.GetTextExtent("Overweight")
		dc.DrawText("Overweight", 180,9)
		#------------------------------------------
		...
		dc.SetFont(wxFont(8, wxSWISS, wxNORMAL, wxNORMAL))
		dc.SetTextForeground(wxColour(0,0,0))
		te = dc.GetTextExtent("Obese")
		dc.DrawText("Obese", 267,9)
		dc.EndDrawing()
...
class BMICalc_Panel(wxPanel):
	def __init__(self, parent, id):
		...
		#------------------------------
		lblheading = wxStaticText(self,-1,"Current Values",wxDefaultPosition,wxDefaultSize,style = wxALIGN_CENTRE)
		...
		label1 = wxStaticText(self,-1,"Height (cm)",size = (1,20))
		...
		label2 = wxStaticText(self,-1,"Weight (kg)",size = (20,20))
		...
		label3 = wxStaticText(self,-1,"BMI",size = (100,20))
		...
		label4 = wxStaticText(self,-1,"Adjusted Values",wxDefaultPosition,wxDefaultSize,style = wxALIGN_CENTRE)  #add underline
		...
		#----------------------
		lblgoal = wxStaticText(self,-1,"Goal weight",size = (30,20))
		...
		#-----------------------------
		lblloss = wxStaticText(self,-1,"Kg to loose",size = (30,20))
