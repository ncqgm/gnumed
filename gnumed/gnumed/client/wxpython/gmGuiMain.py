...
# $Id: gmGuiMain.py,v 1.178 2005-02-03 20:19:16 ncq Exp $
...
#		pass
	...
	def updateTitle(self, anActivity = None):
		...
		if pat.is_connected():
			...
			pat_str = "%s %s.%s (%s) #%d" % (ident['title'][:4], ident['firstnames'], ident['lastnames'], ident['dob'].Format (_('%d/%m/%y')), int(ident['id']))
		else:
