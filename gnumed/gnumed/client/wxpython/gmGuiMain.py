...
#			default_value = u'in surgery',
	...
	def __on_manage_master_data(self, evt):
		...
		master_data_list_names = {
			...
			'substances': _('Substances: Names / ATC'),
			'substance_doses': _('Substance: Doses'),
			'substances_in_brands': _('Substances: Components in branded drugs'),
		...
		map_list2handler = {
			...
			'substance_doses': gmSubstanceMgmtWidgets.manage_substance_doses,
