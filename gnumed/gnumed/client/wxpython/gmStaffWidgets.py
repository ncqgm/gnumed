...
# $Id: gmStaffWidgets.py,v 1.3 2006-06-06 20:54:36 ncq Exp $
...
class cDelistStaffMemberDlg(wxgDelistStaffMemberDlg.wxgDelistStaffMemberDlg):
	...
	def __init_ui_data(self):
		...
		staff_list = gmPerson.get_staff_list(active_only=True)
		for staff in staff_list:
			row_num = self._LCTRL_staff.InsertStringItem(0, label=staff['short_alias'])
