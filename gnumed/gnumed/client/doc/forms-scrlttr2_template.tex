...
\setkomavar{subject}[]{%
	...
	$3<if_not_empty::$<<free_text::Subject of the letter (patient data is added automatically)::120>>$#3#%s\\#3#% no additional Subject by user::>3$
	$3<ph_cfg::argumentsdivider//DEFAULT//%% <%(name)s> set to [%(value)s]::>3$
	$2<ph_cfg::argumentsdivider//#2#//%% <%(name)s> set to [%(value)s]::>3$
