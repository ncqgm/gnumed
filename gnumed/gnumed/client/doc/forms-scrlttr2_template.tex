...
% - PDF metadata
\hypersetup{
	pdftitle = {GENERIC TITLE: $<name::%(firstnames)s %(lastnames)s::>$, $<date_of_birth::%d.%m.%Y::>$},
...
\setkomavar{subject}[]{%
	...
	$<<<ph_cfg::argumentsdivider//DEFAULT//%% <%(name)s> set to [%(value)s]::>>>$
	$<<ph_cfg::argumentsdivider//#2#//%% <%(name)s> set to [%(value)s]::>>$
	Patient: $<title::::>$ $<firstname::::>$ $<lastname::::>$ (born $<date_of_birth::%d.%B %Y::>$)$<<if_not_empty::$<adr_street::home::>$#2#\\#2#::>>$
