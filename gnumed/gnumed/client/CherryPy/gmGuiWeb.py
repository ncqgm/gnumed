...
DEFAULT_BACKEND = "GNUmed database on this machine (Linux/Mac) (gnumed_v19@)"
...
class gmApp:
	...
	# backend is hardcoded for now, make it use drop down list later
        ...
        t = Template( file="CherryPy/templates/index.tmpl"
            ...
            , searchList = {
                ...
                , "backend" : "GNUmed database on this machine (Linux/Mac) (gnumed_v19@)"
            }
        )
	...
	#    <p>Backend</p>
	#    <input type="text" name="backend" value="GNUmed database on this machine (Linux/Mac) (gnumed_v19@)"
