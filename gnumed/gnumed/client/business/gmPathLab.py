...
# $Id: gmPathLab.py,v 1.79.2.1 2010-02-04 16:52:19 ncq Exp $
...
def create_lab_request(lab=None, req_id=None, pat_id=None, encounter_id=None, episode_id=None):
	...
	if req is not None:
		...
		if pat_id != db_pat[0]:
			...
			me = '$RCSfile: gmPathLab.py,v $ $Revision: 1.79.2.1 $'
			to = 'user'
...
#============================================================
# $Log: gmPathLab.py,v $
# Revision 1.79.2.1  2010-02-04 16:52:19  ncq
# - fix faulty get-most-recent-result()
#
