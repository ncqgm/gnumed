...
_VACCINE_SUBSTANCES = {
	...
	'cholera': {
		...
		'atc': u'J07AE01',
		'target': _(u'J07AE01-target::cholera'),
		'v21_indications': [u'cholera']
	},
	'cholera-live': {
		'name': u'cholera, live, attenuated',
		'atc': u'J07AE02',
		'target': _(u'J07AE02-target::cholera'),
	...
	'pneumococcus': {
		...
		'atc': u'J07AL01',
		'target': _(u'J07AL01-target::pneumococcus'),
	...
	'salmo-typh+ent': {
		...
		'atc': u'J07AP10',
		'target': _(u'J07AP10-target::typhoid, paratyphus'),
	...
	'japEnc': {
		...
		'atc': u'J07BA02',
		'target': _(u'J07BA02-target::japanese encephalitis'),
		'v21_indications': [u'japanese B encephalitis']
	},
	'japEnc-live': {
		'name': u'flavivirus, live, attenuated',
		'atc': u'J07BA03',
		'target': _(u'J07BA03-target::japanese encephalitis'),
	...
	'hepA-inact': {
		...
		'atc': u'J07BC02',
		'target': _(u'J07BC02-target::hepatitis A'),
		'v21_indications': [u'hepatitis A']
	},
	'hepA-antig': {
		'name': u'hepatitis A antigen',
		'atc': u'J07BC03',
		'target': _(u'J07BC03-target::hepatitis A')
	},
	...
	'polio-live': {
		...
		'atc': u'J07BF01',
		'target': _(u'J07BF01-target::poliomyelitis'),
		'v21_indications_live': [u'poliomyelitis']
	},
	'polio-inact': {
		'name': u'poliomyelitis, inactivated',
		'atc': u'J07BF03',
		'target': _(u'J07BF03-target::poliomyelitis'),
	...
	'rota-live-atten': {
		...
		'atc': u'J07BH01',
		'target': _(u'J07BH01-target::rotavirus diarrhea')
	},
	'rota-live': {
		'name': u'rotavirus, live',
		'atc': u'J07BH02',
		'target': _(u'J07BH02-target::rotavirus diarrhea'),
	...
	'chickenpox-live': {
		...
		'atc': u'J07BK01',
		'target': _(u'J07BK01-target::varicella (chickenpox)'),
		'v21_indications_live': [u'varicella (chickenpox, shingles)']
	},
	'shingles-live': {
		'name': u'herpes virus (shingles), live',
		'atc': u'J07BK02',
		'target': _(u'J07BK02-target::zoster (shingles)')
	},
...
_GENERIC_VACCINES = {
	...
	'cholera': {
		'name': _(u'cholera vaccine'),
		'atc': u'J07AE',
		'live': False,
		'ingredients': ['cholera']
	},
	'cholera, live': {
		'name': _(u'cholera vaccine, live'),
		'atc': u'J07AE',
		'live': True,
	...
	'meningococcus A': {
		'name': _(u'meningococcus A vaccine'),
		'atc': u'J07AH',
		'live': False,
	...
	'meningococcus B': {
		'name': _(u'meningococcus B vaccine'),
		'atc': u'J07AH',
		'live': False,
	...
	'meningococcus C': {
		'name': _(u'meningococcus C vaccine'),
		'atc': u'J07AH',
		'live': False,
		'ingredients': ['menC']
	},
	...
	'typhoid': {
		'name': _(u'typhoid vaccine'),
		'atc': u'J07AP',
		'live': False,
		'ingredients': ['salmo-inact']
	},
	'typhoid, live': {
		'name': _(u'typhoid vaccine, live'),
		'atc': u'J07AP',
		'live': True,
		'ingredients': ['salmo-live']
	},
	'typhoid, paratyphus': {
		'name': _(u'typhoid/paratyphus vaccine'),
		'atc': u'J07AP10',
		'live': False,
	...
	'typhus exanthematicus': {
		'name': _(u'typhus exanthematicus vaccine'),
		'atc': u'J07AR',
		'live': False,
	...
	'tick-borne encephalitis': {
		'name': _(u'tick-borne encephalitis vaccine'),
		'atc': u'J07BA',
		'live': False,
		'ingredients': ['fsme']
	},
	...
	'japanese encephalitis': {
		'name': _(u'japanese encephalitis vaccine'),
		'atc': u'J07BA',
		'live': False,
		'ingredients': ['japEnc']
	},
	'japanese encephalitis, live': {
		'name': _(u'japanese encephalitis vaccine, live'),
		'atc': u'J07BA03',
		'live': True,
	...
	'influenza': {
		'name': _(u'influenza vaccine'),
		'atc': u'J07BB',
		'live': False,
		'ingredients': ['influ-inact']
	},
	'influenza, live': {
		'name': _(u'influenza vaccine, live'),
		'atc': u'J07BB',
		'live': True,
	...
	'poliomyelitis': {
		'name': _(u'poliomyelitis vaccine'),
		'atc': u'J07BF',
		'live': False,
	...
	'poliomyelitis, live': {
		'name': _(u'poliomyelitis vaccine, live'),
		'atc': u'J07BF',
		'live': True,
	...
	'rotavirus, live': {
		'name': _(u'rotavirus vaccine, live'),
		'atc': u'J07BH',
		'live': True,
	...
	'varicella': {
		'name': _(u'varicella vaccine, live'),
		'atc': u'J07BK',
		'live': True,
		'ingredients': ['chickenpox-live']
	},
	'zoster': {
		'name': _(u'zoster vaccine, live'),
		'atc': u'J07BK',
		'live': True,
	...
	'meningococcus AC': {
		'name': _(u'meningococcus AC vaccine'),
		'atc': u'J07AH03',
		'live': False,
		'ingredients': ['menA', 'menC']
	},
	'meningococcus ACYW135': {
		'name': _(u'meningococcus ACYW135 vaccine'),
		'atc': u'J07AH04', # 4/8
		'live': False,
	...
	'measles, mumps': {
		'name': _(u'measles-mumps vaccine, live'),
		'atc': u'J07BD51',
		'live': True,
	...
	'measles, rubella': {
		'name': _(u'measles-rubella vaccine, live'),
		'atc': u'J07BD53',
		'live': True,
	...
	'mumps, rubella': {
		'name': _(u'mumps-rubella vaccine, live'),
		'atc': u'J07BJ51',
		'live': True,
	...
	'cholera, typhoid': {
		'name': _(u'cholera-typhoid vaccine'),
		'atc': u'J07AE51',
		'live': False,
...
#	},
	...
	'tetanus, diphtheria, poliomyelitis': {
		'name': _(u'TdPol vaccine'),
		'atc': u'J07CA01',
		'live': False,
		'ingredients': ['tetanus', 'diphtheria', 'polio-inact']
	},
	'tetanus, diphtheria, poliomyelitis': {
		'name': _(u'DTPol vaccine'),
		'atc': u'J07CA01',
		'live': False,
		'ingredients': ['tetanus', 'diphtheria', 'polio-inact']
	},
	...
	'tetanus, diphtheria, pertussis, poliomyelitis, HiB, HepB, MenAC': {
		'name': _(u'TdaPPol-HiB-HepB-MenAC'),
		'atc': u'J07CA13',
		'live': False,
